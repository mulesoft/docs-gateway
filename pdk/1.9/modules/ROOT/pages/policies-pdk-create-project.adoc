...
Configures the PDK to use FIPS-compliant cryptographic modules. To maintain FIPS compliance, make sure any additional dependencies you add are compliant.
|===
