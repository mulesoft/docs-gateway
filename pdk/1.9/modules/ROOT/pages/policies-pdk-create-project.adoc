...
If you don't require JWT or XML validation functionality in your custom policy, you can disable these features by adding the PDK dependency to your `Cargo.toml` with the appropriate feature configuration:
