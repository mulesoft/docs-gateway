= Prerequisites for Omni Gateway Policy Development Kit (PDK)
ifndef::env-site,env-github[]
include::_attributes.adoc[]
endif::[]
:imagesdir: ../assets/images

Before you begin using Omni Gateway Policy Development Kit (PDK), review these prerequisites.

== Omni Gateway

PDK tutorials assume that you have xref:gateway::flex-install.adoc[downloaded Omni Gateway] and have some prior knowledge of the product.
...
. Rust programming language version {rust-ver-var} or later
+
...
* Windows
+
IMPORTANT: PDK supports Windows to develop and test you custom policy. However, Omni Gateway does not support Windows in production environments.
+
