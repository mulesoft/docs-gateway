...
Omni Gateway Policy Development Kit (PDK) provides example policy projects to help you start configuring your Rust source code.
...
* https://github.com/mulesoft/pdk-custom-policy-examples/blob/{template-policies-url-ver-var}/tls-calls/README.md[TLS Calls Policy Example]: Use the TLS Calls Policy as an example of how to make HTTPS calls in your policy without installing certificates on the operating system running Omni Gateway.
* https://github.com/mulesoft/pdk-custom-policy-examples/blob/{template-policies-url-ver-var}/websocket/README.md[WebSocket Policy Example]: Use the WebSocket Policy as an example of how to xref:policies-pdk-configure-features-websocket.adoc[support WebSocket APIs] and process bidirectional frames in your custom policy.
