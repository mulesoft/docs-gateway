...
NOTE: The XML Validator library is gated behind a Cargo feature. For information about enabling or disabling XML Validator features in your `Cargo.toml`, see xref:policies-pdk-create-project.adoc#configure-pdk-features[Configure PDK Features in Cargo.toml].
