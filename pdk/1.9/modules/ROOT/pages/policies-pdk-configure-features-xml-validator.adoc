...
NOTE: The XML Validator library is gated behind a Cargo feature and is enabled by default. To disable XML Validator features for your policy, see xref:policies-pdk-create-project.adoc#configure-pdk-features[Configure PDK Features in Cargo.toml].
