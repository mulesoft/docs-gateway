...
NOTE: For an example policy that generate JWT tokens, see https://github.com/mulesoft/pdk-custom-policy-examples/blob/{template-policies-url-ver-var}/jwt-generation/README.md[JWT Generation Example Policy].
