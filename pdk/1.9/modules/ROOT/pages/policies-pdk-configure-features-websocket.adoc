...
:page-notice-banner-message: *Open Beta Release*: The PDK WebSocket library is in open beta. Any use of the WebSocket feature in its beta state is subject to the applicable beta services terms and conditions.

include::reuse::partial$beta-banner.adoc[tag="pdk-websocket"]
