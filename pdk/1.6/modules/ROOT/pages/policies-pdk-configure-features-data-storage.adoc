...
* https://github.com/mulesoft/pdk-custom-policy-examples/blob/{template-policies-url-ver-var}/data-storage-stats/src/lib.rs[`entrypoint` function] for how to configure the `DataStorageBuilder`.
...
* https://github.com/mulesoft/pdk-custom-policy-examples/blob/{template-policies-url-ver-var}/data-storage-stats/src/lib.rs[`get_all_stats` function] for how the policy retrieves stored data.
