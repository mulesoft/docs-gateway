...
The Mulesoft MCP Server provides `manage_flex_gateway_policy_project`, `get_flex_gateway_policy_example`, and `manage_api_instance_policy` tools to create and manage custom policies.
