...
PDK provides xref:pdk::policies-pdk-policy-templates.adoc[example policies] to help you get started with policy development and the xref:mulesoft-mcp-server::reference-mcp-tools.adoc#policy-management[MuleSoft MCP Server Policy Management Tools] to help you build policies with AI.
