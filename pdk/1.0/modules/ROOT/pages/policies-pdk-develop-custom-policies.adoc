...
. xref:policies-pdk-intergration-tests.adoc[Write Integration Tests].
+
Write intergration tests to ensure your custom policy is compatible with your other services and to ensure that each new version does not introduce regression errors.
