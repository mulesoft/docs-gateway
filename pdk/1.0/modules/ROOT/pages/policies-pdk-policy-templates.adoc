...
Flex Gatewayß Policy Development Kit (PDK) provides example policy projects to get started configuring your Rust source code.
...
== Setup an Example Policy Project

To begin using an example policy project:

. Ensure you have installed all xref:policies-pdk-prerequisites.adoc[].
