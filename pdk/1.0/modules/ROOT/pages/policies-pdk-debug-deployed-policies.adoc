...
Flex Gateway Policy Development Kit (PDK)'s' debugging playground provides an easy way to view Flex Gateway logging and send a variety of requests. However, there may be some differences between it and your production environment. Use PDK's debugging playground before debugging on a Flex Gateway instance.
