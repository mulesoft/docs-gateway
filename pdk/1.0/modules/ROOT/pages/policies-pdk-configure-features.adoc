...
You can only make HTTP calls to services defined in the Flex Gateway configuration files. For more information about defining services, see xref:gateway::flex-local-configuration-reference-guide.adoc#service[Services].
