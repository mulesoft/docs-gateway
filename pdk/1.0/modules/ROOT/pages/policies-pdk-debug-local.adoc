...
To test the functionality of your policy, Policy Development Kit (PDK) provides a pre-configured API instance located in the `<root-directory>/playground/config` directory.
