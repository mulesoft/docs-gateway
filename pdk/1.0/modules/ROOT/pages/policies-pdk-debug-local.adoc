...
The Policy Development Kit (PDK) provides a preconfigured API instance located in the `<root-directory>/playground/config` directory to begin testing your policy.
...
* xref:flex-local-reg-run-up.adoc#docker[Register with a Username and Password]
* xref:flex-local-reg-run-app.adoc#docker[Register with a Connected App]
* xref:flex-local-reg-run-token.adoc#docker[Register with a Token]
