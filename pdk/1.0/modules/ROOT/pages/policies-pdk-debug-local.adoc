...
The Policy Development Kit (PDK) provides a preconfigured API instance located in the `<root-directory>/playground/config` directory to test the functionality of your policy.
