...
* xref:gateway::flex-local-reg-run-up.adoc#docker[Register with a Username and Password]
* xref:gateway::flex-local-reg-run-app.adoc#docker[Register with a Connected App]
* xref:gateway::flex-local-reg-run-token.adoc#docker[Register with a Token]
