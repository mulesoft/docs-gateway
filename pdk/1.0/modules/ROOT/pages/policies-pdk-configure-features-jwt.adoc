...
To extract JWT tokens from a different source or with a different format, you can implement Rust logic to get any other part of the request. 

In case this wants to be parameterized in the configuration, you can use Dataweave.
...
* Has the correct custom `role` claim by using a Datweave expression.
