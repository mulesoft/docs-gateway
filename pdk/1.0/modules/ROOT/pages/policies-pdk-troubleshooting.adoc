...
It is recommended to use the Organization ID for the value `ANYPOINT_ORG`. However, if you cannot change the variable, there are two options to provide the Group ID:
