...
If your policy interacts with external services, use the Flex Gateway exposed HttpClient. For more information about performing an HTTP call, see xref:policies-pdk-configure-http-request.adoc[].
