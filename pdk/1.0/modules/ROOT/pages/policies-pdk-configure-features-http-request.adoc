...
In policy's Rust source code, you can access the defined external service in the `Config` struct. To perform requests, call the HTTP client in your policy similar to the following example:
