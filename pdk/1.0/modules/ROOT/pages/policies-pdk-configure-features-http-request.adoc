...
Define your service as a parameter in you schema definition to reuse your policy with different services. The following code snippit provides an example schema definition for an external service:
