...
Flex Gateway Policy Development Kit (PDK) is a software development kit that enables Flex Gateway users to develop custom policies with ease.
...
Watch the PDK Spotlight video to see a quick overview of PDKß.
