= Reviewing Flex Gateway Policy Development Kit Prerequisites
ifndef::env-site,env-github[]
include::_attributes.adoc[]
endif::[]
:imagesdir: ../assets/images

To begin using Policy Development Kit (PDK), ensure you have the following prerequisites installed.

== Flex Gateway

Your Flex Gateway version must be v1.6.1 or later to support Flex Gateway Policy Development Kit (PDK) policies.

The PDK tutorials assume that you have xref:gateway::index.adoc[downloaded Flex Gateway] and have some prior knowledge of the product.
