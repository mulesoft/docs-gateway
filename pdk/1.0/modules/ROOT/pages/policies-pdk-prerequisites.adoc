...
. xref:4.x@anypoint-cli::install.adoc[Install Anypoint CLI v4 (version 1.4.4 or later. You can check your current version by running `anypoint-cli-v4 version`)].
