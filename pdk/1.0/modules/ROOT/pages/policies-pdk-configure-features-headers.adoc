...
With Flex Gateway Policy Development Kit (PDK), you can read and writer to request and response headers and bodies.
...
* Policies can’t modify headers after the body is read.
