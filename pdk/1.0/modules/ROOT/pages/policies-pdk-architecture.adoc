...
Flex Gateway Policy Development Kit (PDK) consists of the:
...
The Anypoint CLI PDK plugin creates the PDK project and uploads policy assets to Exchange. After creating the project, PDK provides a simplified set of commands in a `Makefile` to complete all following development steps.
...
* Less compile and runtime errors from using methods in the incorrect context
