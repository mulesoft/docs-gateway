...
* `vars`: Specifies the names of the variables that are available for the policy to use. By default, `vars` is empty. If the user inputs variables in the expression that are not defined in the schema, the variables evaluate to null.
