...
Use the Flex Gateway Policy Development Kit (PDK) `enable_stop_iteration` feature to simultaneously read and modify headers and body content and maintain header context throughout request processing.
