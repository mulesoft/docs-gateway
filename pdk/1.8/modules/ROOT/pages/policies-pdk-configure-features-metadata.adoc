...
PDK exposes a `Metadata` injectable that provides metadata about the policy, the Omni instance, the API instance, and the Anypoint Organization. The `Metadata` struct is as follows:
