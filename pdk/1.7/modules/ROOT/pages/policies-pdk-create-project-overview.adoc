...
The source code for Flex Gateway Policy Development Kit (PDK) policies are comprised of two versioned parts:

* Definition: The policy's metadata and cofiguration parameters.
* Implementation: The policy's source code and the output of the project build (WebAssembly binary).
