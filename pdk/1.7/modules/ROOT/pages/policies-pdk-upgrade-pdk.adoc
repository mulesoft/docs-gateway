...
----
+
NOTE: In PDK 1.7.0, the name of the Anypoint CLI PDK plugin was changed from `anypoint-cli-pdk-plugin` to `anypoint-pdk-plugin`. To install the new plugin, see <<upgrade-anypoint-cli-pdk-plugin-earlier-1.7.0>>.
...
In PDK 1.7.0, the name of the Anypoint CLI PDK plugin was changed from `anypoint-cli-pdk-plugin` to `anypoint-pdk-plugin`. To upgrade your earlier versions, you must unistall the old plugin before installing the new one:
