= Reading and Writing Request Headers and Bodies with Separate Event States
ifndef::env-site,env-github[]
include::_attributes.adoc[]
endif::[]
:imagesdir: ../assets/images

With Omni Gateway Policy Development Kit (PDK), you can read and write to request and response headers and bodies and read from a streamed body.
