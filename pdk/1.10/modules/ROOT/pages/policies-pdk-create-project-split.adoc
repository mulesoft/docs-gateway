...
After you <<create-a-new-policy-implementation-project, create a new policy project>>, you must run the `make setup` command to download additional software dependencies:
...
The `AGENTS.md` file provides documentation and guidance for AI coding agents (such as Claude Code, GitHub Copilot, or other AI assistants) working with the custom policy project. This documentation enables AI assistants to provide more accurate code suggestions and helps prevent common errors when working with PDK projects. This file includes:
