...
When the definition is reused, you only need to update the policy implementation in your API. See xref:gateway::gateway-secure-conn.adoc#upgrade-policy-implementation[Upgrade a Policy Implementation].
