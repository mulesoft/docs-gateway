= Prerequisites for Flex Gateway Policy Development Kit (PDK)
ifndef::env-site,env-github[]
include::_attributes.adoc[]
endif::[]
:imagesdir: ../assets/images

Before you begin using Flex Gateway Policy Development Kit (PDK), review these prerequisites.

== Flex Gateway

PDK tutorials assume that you have xref:gateway::flex-install.adoc[downloaded Flex Gateway] or have access to a xref:gateway::flex-gateway-managed-set-up.adoc[Managed Flex Gateway], and have some prior knowledge of the product.

include::release-notes::partial$pdk/pdk-supported-versions.adoc[tags=intro;1.3.0]
...
. Rust programming language version {rust-ver-var} to {rust-ver-max-var}:
...
+
.. Due to the `wasm32-wasi` compilation target used by the PDK being deprecated in Rust v1.84.0, downgrade Rust to the last compatible version:
+
[source,ssh,subs="attributes+"]
----
rustup default {rust-ver-max-inline-var}
----
