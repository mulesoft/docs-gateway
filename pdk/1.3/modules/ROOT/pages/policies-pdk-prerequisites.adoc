...
PDK tutorials assume that you have xref:gateway::flex-install.adoc[downloaded Flex Gateway] and have some prior knowledge of the product.
...
To install Docker, see https://docs.docker.com/get-started/get-docker/[Install Docker^].
