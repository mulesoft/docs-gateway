...
* https://github.com/mulesoft/pdk-custom-policy-examples/blob/main/agent-policies/a2a-support-policy/README.md[A2A Support Policy Example^]: Use the A2A Support Policy as an example of how to add A2A Support.
* https://github.com/mulesoft/pdk-custom-policy-examples/blob/main/agent-policies/mcp-support-policy/README.md[MCP Support Policy Example^]: Use the MCP Support Policy as an example of how to add MCP Support.
* https://github.com/mulesoft/pdk-custom-policy-examples/blob/main/agent-policies/a2a-pii-detector-policy/README.md[A2A PII Detector Policy Example^]: Use the A2A PII Detector Policy as an example of how to log or block sensitive information in A2A  agent interactions.
* https://github.com/mulesoft/pdk-custom-policy-examples/blob/main/agent-policies/a2a-prompt-decorator-policy/README.md[A2A Prompt Decorator Policy Example^]: Use the A2A Prompt Decorator Policy as an example of how to modify the prompt sent to an A2A agent.
