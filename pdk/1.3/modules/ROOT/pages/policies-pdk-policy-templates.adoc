...
Although the included xref:gateway::flex-agent-policies.adoc[] already provides support for A2A and MCP, you can use these example policies to understand how to customize Flex Gateway support for A2A and MCP:
