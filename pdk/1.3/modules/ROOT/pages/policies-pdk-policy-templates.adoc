...
In addition to the included xref:gateway::flex-agent-policies.adoc[], you can use these example policies to customize how Flex Gateway handles support for A2A and MCP:
