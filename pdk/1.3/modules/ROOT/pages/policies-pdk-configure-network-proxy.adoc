...
* https://docs.docker.com/engine/cli/proxy/[Docker CLI Client^]
* https://docs.docker.com/desktop/settings-and-maintenance/settings/[Docker Desktop on Mac^]
* https://docs.docker.com/desktop/settings-and-maintenance/settings/[Docker Desktop on Windows^]
* https://docs.docker.com/desktop/settings-and-maintenance/settings/[Docker Desktop on Linux^]
