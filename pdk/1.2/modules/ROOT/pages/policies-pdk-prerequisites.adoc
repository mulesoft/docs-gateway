...
----
+
The compilation target used by the PDK, wasm32-wasi, was deprecated in rust v1.84.0.
Downgrade Rust to the last compatible version execute the following command:
+
[source,ssh]
----
