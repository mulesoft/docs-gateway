...
. Rust programming language from {rust-ver-var} to {rust-ver-max-var}
+
...
+
NOTE: The compilation target used by the PDK, wasm32-wasi, was deprecated in rust v1.84.0. 
To downgrade Rust to the last compatible version execute the following command:
