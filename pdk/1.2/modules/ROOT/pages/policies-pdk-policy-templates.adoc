...
* https://github.com/mulesoft/pdk-custom-policy-examples/blob/main/cors-validation/README.md[CORS Validation Policy Example^]: Use the CORS Validation Policy as an example of how to use functions of the xref:policies-pdk-configure-features-cors.adoc[CORS Library] in your custom policy.
