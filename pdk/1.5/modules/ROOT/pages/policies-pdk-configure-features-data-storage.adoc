...
* https://github.com/mulesoft/pdk-custom-policy-examples/blob/{template-policies-url-ver-var}/data-storage-stats/src/lib.rs[`update_request_stats` function] for how the policy uses CAS operations with retry logic for concurrent updates.
