...
For an example of how to configure Redis shared storage for testing, see the example https://github.com/mulesoft/pdk-custom-policy-examples/blob/{template-policies-url-ver-var}/multi-instance-rate-limiting/playground/shared-storage-redis.yaml[`playground/config/shared-storage-redis.yaml`] file.
 and https://github.com/mulesoft/pdk-custom-policy-examples/blob/{template-policies-url-ver-var}/multi-instance-rate-limiting/playground/config/docker-compose.yaml[`playground/docker-compose.yaml`] files.
