...
:page-aliases: api-manager::policy-mule3-available-policies.adoc, policies::policies-mule3-available-policies.adoc
...
|===
|Policy | Summary
| xref:policies-included-api-security-identification-header.adoc[API Security-Identification Header] | Adds API instance identifiers as response headers for external security platform correlation
