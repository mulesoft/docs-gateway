...
:page-aliases: api-manager::policies-ootb-landing-page.adoc, api-manager::policy-mule3-available-policies.adoc, policies::policies-mule3-available-policies.adoc
