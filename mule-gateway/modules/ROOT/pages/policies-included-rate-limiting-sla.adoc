...
:page-aliases: api-manager::rate-limiting-sla-policy.adoc, api-manager::rate-limiting-and-throttling-sla-based-policies.adoc, api-manager::tutorial-manage-an-api.adoc, api-manager::policy-mule3-rate-limiting-and-throttling-sla-based-policies.adoc, policies::policies-mule3-rate-limiting-and-throttling-sla-based-policies.adoc, api-manager::policy-mule3-tutorial-manage-an-api.adoc, policies::policies-mule3-tutorial-manage-an-api.adoc
