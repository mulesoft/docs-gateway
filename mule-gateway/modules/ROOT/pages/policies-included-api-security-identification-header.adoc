...
The API Security-Identification Header policy injects organization and API instance identifiers as response headers to enable integration with external security platforms such as Noname Security and Akamai.
