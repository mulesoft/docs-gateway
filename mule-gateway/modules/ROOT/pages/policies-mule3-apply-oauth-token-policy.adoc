...
:page-aliases: api-manager::policy-mule3-apply-oauth-token-policy.adoc, policies::policies-mule3-apply-oauth-token-policy.adoc
...
+
image::scopes-mule4.png["A form shows scope validation criteria with options to contain all scopes or any scope",height=160,width=496]
+
...
image::access-token.png["A text field for the Access Token validation endpoint URL",height=278,width=767]
...
image::external-oauth-2_0-token-validation-policy-ba3c0.png["A form that enables the configuration of the OAuth 2.0 access token enforcement policy",height=375,width=404]

== See Also

* xref:policies-included-apply.adoc[]
* https://datatracker.ietf.org/doc/html/rfc6749[Supported OAuth scopes^]
