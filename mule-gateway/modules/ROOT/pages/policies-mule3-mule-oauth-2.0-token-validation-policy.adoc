...
:page-aliases: api-manager::policy-mule3-mule-oauth-2.0-token-validation-policy.adoc, policies::policies-mule3-mule-oauth-2.0-token-validation-policy.adoc
...
None of the token enforcement policies work with a Mule client app to access OAuth 2.0-protected resources outside Anypoint Platform. Instead, configure the HTTP Requester connector for this purpose.
...
* xref:http-connector::http-authentication.adoc[]
