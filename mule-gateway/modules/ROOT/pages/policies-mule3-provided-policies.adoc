...
image::select-policy.png["A table shows security policies and their requirements"]
...
image::policy-filters.png["A form displays policy options and requires selection"]
