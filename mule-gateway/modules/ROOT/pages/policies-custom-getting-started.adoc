...
:page-aliases: api-manager::custom-policy-getting-started.adoc, policies::policies-custom-getting-started.adoc, api-manager::policy-mule3-creating-custom-policy.adoc, policies::policies-mule3-creating-custom-policy.adoc
