...
:page-aliases: api-manager::custom-policy-getting-started.adoc, policies::policies-custom-getting-started.adoc
...
*Are all connectors allowed as policy dependencies?*

No, connectors that require to export resources can not be used in custom policies. For example, this includes Java and Spring connectors.
...
* xref:policies-custom-overview.adoc[Reviewing Custom Policy concepts]
