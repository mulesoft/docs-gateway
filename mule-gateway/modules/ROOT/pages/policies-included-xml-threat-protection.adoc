...
:page-aliases: api-manager::apply-configure-xml-threat-task.adoc, api-manager::json-xml-threat-policy.adoc, policies::policies-included-xml-threat-protection.adoc, api-manager::policy-mule3-xml-threat.adoc, policies::policies-mule3-xml-threat.adoc
...
The XML Threat Protection policy is not supported in Omni Gateway Local Mode.

=== Omni Gateway Connected Mode

The XML Threat Protection policy is not supported in Omni Gateway Connected Mode.
