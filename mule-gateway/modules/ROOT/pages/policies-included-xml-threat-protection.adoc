...
:page-aliases: api-manager::apply-configure-xml-threat-task.adoc, api-manager::json-xml-threat-policy.adoc, policies::policies-included-xml-threat-protection.adoc
