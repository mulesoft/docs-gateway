...
// or xref:service-mesh::index.adoc[non-Mule application managed by Anypoint Service Mesh].

==== Configuring Parameters for Mule Applications and Omni Gateway
...
- *Omni Gateway*: specify this property in YAML policy config:
