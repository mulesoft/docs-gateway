...
image::apim-message-logging-policy-ui.png["A form to add a new logging configuration"]
...
+
image::apim-message-logging-policy-states-1.png["A sequence diagram that illustrates the state before logging an API flow"]
* After logging an API flow:
+
image::apim-message-logging-policy-states-2.png["A sequence diagram that illustrates the state after logging an API flow"]
* Error handler after API flow:
+
image::apim-message-logging-policy-states-3.png["A sequence diagram that illustrates the state after the error handler executes"]
