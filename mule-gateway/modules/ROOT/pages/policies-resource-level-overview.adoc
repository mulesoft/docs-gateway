...
:page-aliases: api-manager::policies-policy-level.adoc, api-manager::resource-level-policies-about.adoc, api-manager::policy-mule3-resource-level-policies.adoc, policies::policies-mule3-resource-level-policies.adoc, api-manager::policy-mule3-resource-level-custom-policy.adoc, policies::policies-mule3-resource-level-custom-policy.adoc, api-manager::policy-mule3-prepare-raml.adoc, policies::policies-mule3-prepare-raml.adoc
...
image::users-api-cropped.png["API requests related to user permissions and the corresponding HTTP methods allowed for each",height=329,width=732]
