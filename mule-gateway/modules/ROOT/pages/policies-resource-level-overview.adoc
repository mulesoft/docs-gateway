...
:page-aliases: api-manager::policy-mule3-resource-level-policies.adoc, policies::policies-mule3-resource-level-policies.adoc, api-manager::policy-mule3-resource-level-custom-policy.adoc, policies::policies-mule3-resource-level-custom-policy.adoc, api-manager::policy-mule3-prepare-raml.adoc, policies::policies-mule3-prepare-raml.adoc
