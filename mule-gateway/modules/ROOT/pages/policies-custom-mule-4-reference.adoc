...
[CAUTION]
--
Custom policy cannot use connectors that export resources or packages such as Java classes. For example, custom policies cannot use the Java or Spring connectors.
--
