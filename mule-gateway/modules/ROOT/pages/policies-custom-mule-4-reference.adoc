...
[CAUTION]
--
It is not possible for a policy to use connectors that require to export resources or packages such as Java classes.
This includes Java and Spring connectors for example.
--
