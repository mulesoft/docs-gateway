...
image::quota-policy-formula.png["A policy formula example"]

where image:omega.png["A symbol representing omega in the expression"] is a small number, below the backend maximum capacity.
