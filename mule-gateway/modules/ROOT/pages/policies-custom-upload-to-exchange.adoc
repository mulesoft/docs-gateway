...
:page-aliases: api-manager::custom-policy-uploading-to-exchange.adoc, policies::policies-custom-upload-to-exchange.adoc
...
If you create your custom policy project using the provided Maven archetype, the plugins necessary to upload the policy to Exchange are already defined for you. See xref:policies-custom-getting-started.adoc#setting-up-a-project-with-the-archetype[Setting Up a Project with the Archetype].
...
+
NOTE: For Java 17 support, add `supportedJavaVersions: ["8", "11", "17"]` to the policy definition YAML. See xref:policies-custom-mule-4-reference.adoc#yaml-configuration-file[YAML Configuration File].
