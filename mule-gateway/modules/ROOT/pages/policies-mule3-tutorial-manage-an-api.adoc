...
:page-aliases: api-manager::policy-mule3-tutorial-manage-an-api.adoc, policies::policies-mule3-tutorial-manage-an-api.adoc
...
* xref:policies-mule3-rate-limiting-and-throttling.adoc[]
* xref:policies-mule3-rate-limiting-and-throttling-sla-based-policies.adoc[]
