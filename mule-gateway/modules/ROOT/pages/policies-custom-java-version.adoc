...
For this, the supportedJavaVersions field must be added. We’ll use the OOTB Basic Authentication policy as an example.
...
technolog
y: mule4supportedJavaVersions: ["8", "11", "17"]
