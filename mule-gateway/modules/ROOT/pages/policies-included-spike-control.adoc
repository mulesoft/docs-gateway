...
:keywords: spike control, api gateway, mule gateway, gateway, policy
:page-aliases: api-manager::spike-control-reference.adoc, api-manager::policy-mule3-throttling-rate-limit.adoc, policies::policies-mule3-throttling-rate-limit.adoc
...
To enforce request quotas, see the xref:policies-included-rate-limiting-sla.adoc[Rate-Limiting SLA policy] and xref:policies-included-rate-limiting.adoc[Rate Limiting policy].
...
image::spike-control.png["A timeline that shows accepted, rejected, and queued requests"]
