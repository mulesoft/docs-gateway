...
:page-aliases: api-manager::header-removal-policy.adoc, api-manager::policy-mule3-remove-headers-policy.adoc, policies::policies-mule3-remove-headers-policy.adoc
