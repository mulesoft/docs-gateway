...
:page-aliases: api-manager::basic-authentication-simple-concept.adoc, api-manager::policy-mule3-simple-security-manager.adoc, policies::policies-mule3-simple-security-manager.adoc, api-manager::policy-mule3-http-basic-authentication-policy.adoc, policies::policies-mule3-http-basic-authentication-policy.adoc
