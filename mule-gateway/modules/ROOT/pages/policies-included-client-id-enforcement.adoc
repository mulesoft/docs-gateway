...
:page-aliases: api-manager::client-id-based-policies.adoc, api-manager::policy-mule3-client-id-based-policies.adoc, policies::policies-mule3-client-id-based-policies.adoc
...
* xref:policies-included-oauth-access-token-enforcement.adoc[]
* xref:policies-included-pingfederate-oauth-token-enforcement.adoc[]
* xref:policies-included-openam-oauth-token-enforcement.adoc[]
...
In this example, the requester must send the two specified query parameters with the request. Although this is a supported configuration, it poses possible security risks. The recommended method is to use headers. DataWeave 2.0 is fully supported in Mule 4 as wells as a subset in Omni.
//TODO: LINK to DW Omni support for v1.0.0 docs TBD.
