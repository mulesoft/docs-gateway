...
MuleSoft provides several ready-to-use policies for areas such as authentication, security management, and threat protection. Using the API Manager from Anypoint Platform, you can apply any of these policies to any of your API endpoints.
...
//It would actually be a good thing to add in the future, a section about CI and the link to the API Manager portal. -- Eva?
