...
== Updating Policy Implementations

After publishing a new implementation to Exchange:

. Update the definition version from the dropdown.
. Click *More (...)* > *Check for implementation updates* > *Update*.

Both steps are required to apply the new implementation.