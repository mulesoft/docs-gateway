...
The Tokenization policy is not supported in Omni Gateway Local Mode.

=== Omni Gateway Connected Mode

The Tokenization policy is not supported in Omni Gateway Connected Mode.
...
image::policy-mule4-tokenization-67b25.png["A diagram shows a data flow between security, tokenization, and a Mule application"]
...
image::policy-mule4-tokenization-9347d.png["A diagram shows a data flow of a tokenization service"]
