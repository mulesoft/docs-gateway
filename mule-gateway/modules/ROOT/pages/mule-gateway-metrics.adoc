...
IMPORTANT: This feature might affect the performance of the request processing due to the amount of logs that are generated, so take it in consideration.
IMPORTANT: This feature is available in releases and monthly versions released after February 1, 2024.
