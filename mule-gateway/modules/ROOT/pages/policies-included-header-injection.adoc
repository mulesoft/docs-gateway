...
:page-aliases: api-manager::header-injection-policy.adoc, general::header-inject-remove-task.adoc, api-manager::policy-mule3-add-headers-policy.adoc, policies::policies-mule3-add-headers-policy.adoc
