...
NOTE: Deleting cached policy assets is only supported in Mule runtime versions 4.4.X released after Feb 1, 2024 and Mule runtime versions 4.6.0 and later. Deleting cached policy assets is not supported in Mule Runtime 4.5.x.
