...
For Mule Runtime versions 4.6.0 or later, automatically delete unused cached files when the runtime starts by adding the following entry to the `wrapper.conf` file:
