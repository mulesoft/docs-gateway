...
:keywords: cross origin resource sharing, cors, api gateway, mule gateway, gateway, policy
:page-aliases: api-manager::cors-policy.adoc, api-manager::policy-mule3-cors-policy.adoc, policies::policies-mule3-cors-policy.adoc
...
image:cors-policy-sop-example.png["A table shows URL comparison results, including outcome and reason",95%,85%]
