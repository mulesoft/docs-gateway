...
:page-aliases: api-manager::rate-limiting.adoc, api-manager::rate-limiting-and-throttling.adoc, api-manager::policy-mule3-apply-rate-limiting.adoc, policies::policies-mule3-apply-rate-limiting.adoc, api-manager::policy-mule3-rate-limiting-and-throttling.adoc, policies::policies-mule3-rate-limiting-and-throttling.adoc
