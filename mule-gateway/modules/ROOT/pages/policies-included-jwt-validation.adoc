...
:keywords: jwt validation, api gateway, mule gateway, gateway, policy
// :page-aliases: api-manager::policy-mule4-jwt-validation.adoc, gateway::policies-included-jwt-validation.adoc
...
| 256, 384, 512. For ES method, Omni Gateway only supports 256 key length.
