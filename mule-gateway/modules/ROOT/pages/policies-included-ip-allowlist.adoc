...
:keywords: ip, allowlist, validation, api gateway, mule gateway, gateway, policy
...
You can specify a DataWeave 2.0 expression to define the source IP used by the policy to determine whether the IP belongs to the policy's restricted IP list.
