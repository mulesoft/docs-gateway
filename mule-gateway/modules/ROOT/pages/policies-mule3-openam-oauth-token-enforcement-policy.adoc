...
image::openam-oauth-token-enforcement-policy-0fbb9.png["A flowchart diagram of an API authorization process"]
...
* xref:api-manager::apply-oauth-token-policy-task.adoc[]
