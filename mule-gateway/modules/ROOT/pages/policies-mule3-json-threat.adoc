...
:page-aliases: api-manager::policy-mule3-json-threat.adoc, policies::policies-mule3-json-threat.adoc
...
+
image::json-threat-policy.png["A form allows configuration of JSON threat protection policies"]
+
