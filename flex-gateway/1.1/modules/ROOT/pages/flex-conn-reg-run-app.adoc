...
:page-aliases: gateway::flex-conn-reg-run-app.adoc
...
|image:install-kubernetes-logo.png[20%,20%,xref="flex-conn-reg-run-app.adoc#register-and-run-with-a-connected-app-as-a-kubernetes-ingress-controller"]
...
|xref:flex-conn-reg-run-app.adoc#register-and-run-with-a-connected-app-as-a-kubernetes-ingress-controller[Register and Run With a Connected App as a Kubernetes Ingress Controller]
|===
...
include::partial$task-reg-run-flex-gateway.adoc[tags=app-k8s-heading;k8s-reg-command-intro;sub-coll-info;app-replace-content;environment-replace-content;replace-content;reg-command-heading;reg-command-1;docker-reg-command;app-reg-command;environment-reg-command;connected-reg-command;organization-reg-command;output-reg-command-docker;reg-command-2;after-reg;k8s-after-reg;connected-after-reg;k8s-install-helm-chart;gateway-connected;helm-chart-options]
