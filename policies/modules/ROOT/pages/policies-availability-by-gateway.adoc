...
| OAuth 2.0 OBO Credential Injection ^| xref:gateway::policies-outbound-oauth-obo.adoc[✓] ^| | Exchanges incoming bearer tokens using the OAuth 2.0 Token Exchange (RFC 8693) protocol
