...
| In-Task Authorization Code ^| xref:gateway::policies-outbound-a2a-intask-authentication.adoc[✓] ^| | Ensures secondary credentials are present for in-task authentication using OAuth 2.0 Authorization Code flow
