...
| Circuit Breaker ^| xref:gateway::policies-outbound-circuit-breaker.adoc[✓] ^| | | Prevents an upstream from receiving too many requests or connection
...
| Credential Injection Basic Authentication ^| xref:gateway::policies-outbound-oauth.adoc[✓] ^| | | Injects an OAuth 2.0 authorization header into outgoing requests
...
| Response Time ^| xref:gateway::policies-included-response-timeout.adoc[✓] ^| | | Sets a maximum amount of a time Flex Gateway waits for a response from an upstream service
...
| Stream Idle Timeout ^| xref:gateway::policies-included-stream-idle-timeout.adoc[✓] ^| | | Sets a maximum amount of a time a stream can remain idle without receiving a request or response
...
| Upstream Idle Timeout ^| xref:gateway::policies-outbound-upstream-idle-timeout.adoc[✓] ^| | | Sets a maximum amount of a time a stream between Flex Gateway and a upstream service can remain idle
