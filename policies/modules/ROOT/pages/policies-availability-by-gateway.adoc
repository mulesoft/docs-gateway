...
| MCP PII Detector ^| xref:gateway::policies-included-mcp-pii-detector.adoc[✓] ^| | Detects, mask, and redacts personally identifiable information (PII) in MCP server requests and responses
