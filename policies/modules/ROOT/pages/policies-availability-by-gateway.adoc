...
| OAuth 2.0 OBO Credential Injection ^| xref:gateway::policies-outbound-oauth-obo.adoc[✓] ^| | Exchanges incoming bearer token for a new token targeting an upstream service using OAuth 2.0 Token Exchange (RFC 8693)
