...
| DataWeave Transformation ^| xref:gateway::policies-included-dataweave-transformation.adoc[✓] ^| ^| Transforms or evaluates request and response messages with DataWeave scripts (header, body, or script evaluation)
