...
| AWS Signature ^| xref:gateway::policies-outbound-aws-signature.adoc[✓] ^| | Signs outgoing requests with AWS Signature Version 4 (SigV4) or Signature Version 4A (SigV4A)
