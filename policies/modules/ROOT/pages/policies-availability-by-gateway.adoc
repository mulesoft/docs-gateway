...
| Body Transformation ^| xref:gateway::policies-included-body-transformation.adoc[✓] ^| ^| Transforms request or response body content with a DataWeave script
...
| Header Transformation ^| xref:gateway::policies-included-header-transformation.adoc[✓] ^| ^| Transforms request or response headers with a DataWeave script
...
| Script Evaluation Transformation ^| xref:gateway::policies-included-script-evaluation-transformation.adoc[✓] ^| ^| Evaluates a DataWeave script on request or response to allow or block the message
