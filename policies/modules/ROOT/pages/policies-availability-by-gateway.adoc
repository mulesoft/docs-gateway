...
| In-Task Authorization Code ^| xref:gateway::policies-outbound-a2a-intask-authentication.adoc[✓] ^| | Enforces OAuth 2.0 authorization code flow for A2A in-task authentication
