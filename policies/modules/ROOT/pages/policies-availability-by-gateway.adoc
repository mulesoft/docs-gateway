...
| Response Timeout ^| xref:gateway::policies-included-response-timeout.adoc[✓] ^| | | Sets a maximum amount of a time Flex Gateway waits for a response from an upstream service
