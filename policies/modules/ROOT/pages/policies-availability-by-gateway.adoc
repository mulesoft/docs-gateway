...
| Traffic Management for Upstream Services ^| xref:gateway::policies-included-traffic-management-route.adoc[✓] ^| ^| | Manages API instance traffic to upstream services from a single consumer endpoint
