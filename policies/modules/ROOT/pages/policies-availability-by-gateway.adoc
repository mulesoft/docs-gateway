...
| MCP Tool Mapping ^| xref:gateway::policies-included-mcp-tool-mapping.adoc[✓] ^| | Renames MCP tool names in requests and responses, providing flexible tool name transformation capabilities
