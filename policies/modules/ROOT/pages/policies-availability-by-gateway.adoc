...
| A2A In-Task Authentication ^| xref:gateway::policies-included-a2a-intask-authentication.adoc[✓] ^| | Ensures OAuth 2.0 tokens are present for A2A in-task authentication
