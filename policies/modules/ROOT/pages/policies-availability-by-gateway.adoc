...
| Credential Injection JWT Generation ^| xref:gateway::policies-outbound-jwt-generation.adoc[✓] ^| | Generates a JWT and injects it as a Bearer token in the Authorization header into outgoing requests
