...
| DataWeave Request Filter ^| xref:gateway::policies-included-dataweave-request-filter.adoc[✓] ^| ^| Evaluates a DataWeave script on request or response to allow or block the message
