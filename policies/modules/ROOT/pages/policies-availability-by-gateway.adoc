...
| MCP Global Access ^| xref:gateway::policies-included-mcp-global-access.adoc[✓] ^| | Restricts which MCP tools, resources, and prompts are exposed by defining Allow and Block rules
