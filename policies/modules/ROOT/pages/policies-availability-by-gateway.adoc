...
| Traffic Management for Single Upstream Service ^| xref:gateway::policies-included-traffic-management-single.adoc[✓] ^| ^| | Manages API instance traffic to a single upstream service from a single consumer endpoint
