...
| DataWeave Body Transformation ^| xref:gateway::policies-included-dataweave-body-transformation.adoc[✓] ^| ^| Transforms the body of request or response traffic with a DataWeave script

| DataWeave Headers Transformation ^| xref:gateway::policies-included-dataweave-headers-transformation.adoc[✓] ^| ^| Transforms headers of request or response traffic with a DataWeave script

| DataWeave Request Filter ^| xref:gateway::policies-included-dataweave-request-filter.adoc[✓] ^| ^| Allows to filter requests based on a DataWeave script
