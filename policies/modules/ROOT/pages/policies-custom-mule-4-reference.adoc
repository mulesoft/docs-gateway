...
These examples are developed using Mule extension v1.0.0. Using a different version of the extension might cause the examples to not work as expected. To update your Mule extension version, see xref:policies::policies-custom-http-transform.adoc[HTTP Policy Transform Extension].
...
* xref:policies::policies-custom-http-transform.adoc[Reviewing HTTP Policy Transform Extension]
* xref:policies::policies-custom-mule-4-caching.adoc[Removing HTTP Caching Custom Policy example]
