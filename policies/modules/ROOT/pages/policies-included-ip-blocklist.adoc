...
Based on your business need, you can specify a DataWeave 2.0 expression for Mule 4 and Flex gateways or MEL expression for Mule 3. You specify the expression to define the source IP to be used when the policy tries to determine whether the IP belongs to the restricted IP list defined in the policy.
