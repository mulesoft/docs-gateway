...
Flex Gateway supports schemas defined in JSON or YAML, contained in a file or in an external URI. Additionally, when applying the policy in Flex Gateway Connected Mode, the platform automatically transforms RAML into OAS3. However, the platform might not transform perfectly.
