...
You can configure all xref:gateway::policies-included-directory.adoc[included policies] and xref:gateway::policies-custom-overview.adoc[custom policies] as automated policies and apply them to the APIs running in an environment.
...
[NOTE]
====
xref:gateway::flex-use-api-alerts.adoc[Alerts] cannot be added to API instances protected by automated policies.
====

== See Also

* xref:gateway::policies-automated-applying.adoc[]
