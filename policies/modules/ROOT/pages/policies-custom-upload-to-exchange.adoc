...
// :page-aliases: api-manager::custom-policy-uploading-to-exchange.adoc
...
If you create your custom policy project using the provided Maven archetype, the plugins necessary to upload the policy to Exchange are already defined for you. See xref:policies::policies-custom-getting-started.adoc#setting-up-a-project-with-the-archetype[Setting Up a Project with the Archetype].
...
* xref:policies::policies-custom-mule-4-reference.adoc[Reviewing Custom Policy Concepts]
