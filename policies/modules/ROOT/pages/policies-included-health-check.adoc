...
IMPORTANT: Applying the Health Check policy to API Instances with an outbound TLS context applied causes the Health Check policy to return an unhealthy connection.
