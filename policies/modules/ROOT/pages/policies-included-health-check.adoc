...
The Health Check policy monitors your API by making GET requests to the specified API base path. Requests are made continually at the specified minute intervals with the first request occuring at the specified minute interval after the policy is applied. You must specify a GET request.
