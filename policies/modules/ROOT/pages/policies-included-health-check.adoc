...
The Health Check policy monitors the upstream health of an API at specified intervals. Health check allows you to monitor if an API is active and alerts you if the status of the API changes.
