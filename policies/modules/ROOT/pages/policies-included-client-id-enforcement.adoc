...
* xref:api-manager::policy-openid-connect.adoc[OpenID Connect OAuth 2.0 Token Enforcement] (Flex v1.0.0 or later)
* xref:api-manager::policy-mule4-jwt-validation.adoc[JWT Validation] (Flex v1.0.0 or later)
