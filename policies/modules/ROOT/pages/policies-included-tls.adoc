...
To apply inbound TLS in Local Mode, use the xref:gateway::flex-local-tls-config.adoc[Configuring TLS Context for Flex Gateway in Local Mode] tutorials and refer to the following configuration files in this documentation.
