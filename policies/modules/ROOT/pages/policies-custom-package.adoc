...
:page-aliases: api-manager::custom-policy-packaging-policy.adoc
...
== See Also
**** xref:policies::policies-custom-getting-started.adoc[Getting started with custom policies development]
