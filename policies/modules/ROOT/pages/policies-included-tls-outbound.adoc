...
[NOTE]
====
The TLS policy documentation is only applicable to Local Mode Flex Gateways. To apply TLS in Connected Mode, see xref:gateway::flex-conn-tls-config.adoc[Configuring TLS Context for Flex Gateway in Connected Mode].
====
...
// sample config outbound TLS applied to all apis on gateway intro
include::gateway::partial$task-tls-config.adoc[tags=sample-config-outbound-all-intro]
//sample config outbound TLS applied to all apis on gateway
include::gateway::partial$task-tls-config.adoc[tags=sample-config-outbound-all]

// sample config outbound TLS applied to a a specific instance
include::gateway::partial$task-tls-config.adoc[tags=sample-config-outbound-instance-intro]
// sample config outbound TLS applied to a a specific instance
include::gateway::partial$task-tls-config.adoc[tags=sample-config-outbound-instance]
