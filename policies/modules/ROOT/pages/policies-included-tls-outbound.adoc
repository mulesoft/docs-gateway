...
You can configure an outbound mTLS context to enable authentication between an API proxy and an upstream service, by binding the Transport Layer Security policy to your API instance.
