...
:keywords: detokenization, api gateway, flex gateway, gateway, policy
// :page-aliases: api-manager::policy-mule4-detokenization.adoc
...
The Detokenization policy is not supported in Flex Gateway Local Mode.

=== Flex Gateway Connected Mode

The Detokenization policy is not supported in Flex Gateway Connected Mode.
