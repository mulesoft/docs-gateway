...
ProTeams develops a custom policy by first creating a xref:policies::policies-custom-getting-started.adoc[custom policy archetype project]. Then ProTeams runs the archetype, replacing the values shown in this example.
