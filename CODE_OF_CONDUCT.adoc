...
It includes adaptions and additions from https://golang.org/conduct[Go Community Code of Conduct],  https://github.com/cncf/foundation/blob/{template-policies-url-ver-var}/code-of-conduct.md[CNCF Code of Conduct], and https://opensource.microsoft.com/codeofconduct/[Microsoft Open Source Code of Conduct].
