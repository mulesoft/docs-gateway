...
|===
| Limit | Value | Notes
| APIs per Extra Large Managed Gateway instance | 500 | The platform does not allow to exceed this limit. The Extra Large size is designed for more resource demanding uses cases. i.e. policies with costful processing and/or higher thrpughput. 
