...
LLM Proxy supports both OpenAI and Gemini Responses and Chat Completions requests. This guide only provides OpenAI formatted requests. To learn more about the these OpenAI request types, see:
