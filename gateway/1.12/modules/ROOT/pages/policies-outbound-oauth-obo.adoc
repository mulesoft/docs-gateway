...
>s|Release Notes| xref:release-notes::flex-gateway/flex-gateway-hybrid-policies/credential-injection-oauth2-obo-release-notes.adoc[A2A OAuth2 OBO Credential Injection]
