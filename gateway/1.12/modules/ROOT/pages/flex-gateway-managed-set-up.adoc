...
| *Extra Large Managed Flex Gateway* | Use for production purposes with higher throughput and/or more process demanding policies. Extra Large Managed Flex Gateways can deploy up to 500 APIs.  
|===
+
