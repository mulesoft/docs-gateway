...
Flex Gateway supports the following protocols:
...
You can deploy Flex Gateway as a Managed or Self-Managed Flex Gateway. Managed Flex Gateway provides a fully managed option on CloudHub 2.0 or Runtime Fabric, and Self-Managed Flex Gateway provides more options and control.
...
You can deploy Managed Flex Gateway on CloudHub 2.0 and Runtime Fabric using Runtime Manager. For details see xref:flex-gateway-managed-set-up.adoc[].
