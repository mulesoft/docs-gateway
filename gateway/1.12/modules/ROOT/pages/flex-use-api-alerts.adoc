...
+
image::flex-alerts-edit.png["A table that shows the name of the alert, the metrics it is based on, the severity, the state, and whether the alert is enabled"]
