...
In Local Mode, apply the policy via declarative configuration using the `dataweave-body-transformation-flex` policy. In Managed Flex Gateway and Flex Gateway Connected mode, apply the policy from the UI and select the DataWeave Body Transformation type.
