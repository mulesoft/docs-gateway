...
:page-aliases: api-manager::dataweave-body-transformation-policy.adoc, policies::policies-included-dataweave-body-transformation.adoc
...
In Local Mode, apply the policy via declarative configuration using the `body-transformation-flex` policy. In Managed Flex Gateway and Flex Gateway Connected mode, apply the policy from the UI and select the DataWeave Body Transformation type.
