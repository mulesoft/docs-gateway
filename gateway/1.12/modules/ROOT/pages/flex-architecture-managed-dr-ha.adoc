...
This documentation covers specific details of Managed Flex Gateway high availability and disaster recovery. To fully understand CloudHub 2.0 high availability and disaster recovery, familiarize yourself with xref:cloudhub-2::ch2-ha-dr.adoc[].
