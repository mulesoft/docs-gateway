...
|Protect Path and Query | If enabled, the gateway checks the request path and query string.
|Protect Headers | If enadbled, the gateway checks the request headers.
