...
|Reject Requests | Enable to reject matching requests with `400` response code. Otherwise, the gateway allows them to reach the upstream service and logs a policy violation.
|===
