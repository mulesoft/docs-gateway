...
| Mapped Tool Description | Optional new description for the tool. If not specified, the original description is used. New descriptions are not supported for regex mappings.
...
| Log Mappings | Whether to log tool name mappings for debugging.
|===
