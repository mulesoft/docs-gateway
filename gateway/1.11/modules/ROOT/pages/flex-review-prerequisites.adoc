= Flex Gateway Requirements and Limits
...
Verify permissions, software, hardware, and network requirements before deploying Flex Gateway. Ensure your environment meets minimum requirements for successful installation.
