...
image:http-policy-cache-hit.png["A flowchart diagram illustrating the data flow from a web browser through an API gateway to the backend and the object store"]
