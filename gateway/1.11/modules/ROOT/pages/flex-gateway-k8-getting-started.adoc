= Getting Started with Self-Managed Flex Gateway in a Kubernetes Cluster
...
.. Click *Self-managed Flex Gateways*.
...
+
image::gateway-quickstart-k8-my-gateway-rtm.png["A table of Flex Gateway details, such as name, ID, status, and last updated timestamp"]
+
