...
Anypoint Flex Gateway is an Envoy-based ultrafast API gateway that manages and secures APIs running anywhere and integrates with DevOps and CI/CD workflows. Deploy as a fully managed service or self-manage on your own infrastructure. For self-managed deployments, connect to Anypoint Platform for centralized management in Connected Mode, or configure locally in Local Mode.
