...
Flex Gateway supports applying duplicate policies for all deployment types. Automated, API-level, Outbound, and resource-level policies all support duplicate policy application.
