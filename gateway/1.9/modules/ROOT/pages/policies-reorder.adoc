...
== Order Inbound Instance-Level Policies for Managed Flex Gateway and Connected Mode

To reorder instance-level policies:

. Go to *Anypoint Platform > API Manager*.

. In *API Instanges* or *Agent and Tool Instances*, click the name of the instance whose policies you want to reorder.
