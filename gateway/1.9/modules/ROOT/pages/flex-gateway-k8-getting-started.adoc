...
. Click *Add Self-Managed Flex-Gateway*.
...
+
If the status is *Not Running*, it is likely that the cluster configuration is incorrect or a network issue occurred. Check <<troubleshooting-k8>> for more information.
