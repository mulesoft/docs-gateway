...
| Optional
| `false`
| When `true`, the configured headers, body, and trailers are sent to the external processing server and Flex Gateway does not wait for a response from the processing server.
...
| Observability mode | If enabled, the configured headers, body, and trailers are sent to the external processing server and Flex Gateway does not wait for a response from the processing server.
