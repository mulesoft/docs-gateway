...
For information about configuring resource-level policies for Flex Gateway running in Local Mode, refer to xref:flex-local-secure-api-with-auto-policy.adoc[].
