...
If you are protecting a small number of APIs with low transaction volume, and high availability and robustness are not a major concern, consider using a standalone gateway. Otherwise, use an Ingress controller in Kubernetes.
