...
For protecting a small number of APIs with low transaction volume where high availability and robustness aren't critical, use a standalone gateway. Otherwise, use an Ingress controller in Kubernetes.
