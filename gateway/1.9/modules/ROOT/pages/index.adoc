...
:page-aliases: flex-shared-responsibility.adoc
...
To publish a SOAP API, refer to xref:troubleshoot-soap-apis.adoc[].
...
+
To learn more, see https://www.heroku.com/blog/mastering-api-integration-salesforce-heroku-mulesoft-anypoint-flex-gateway/[Mastering API Integration: Salesforce, Heroku, and MuleSoft Anypoint Flex Gateway].
