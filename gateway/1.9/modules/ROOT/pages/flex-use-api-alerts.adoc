...
. Navigate to *API Manager* > *API Instance* and click the API instance for which you want to add an alert.
...
. In API Manager, click *API Instance* in the left navigation bar.
...
. From API Manager, click *API Instances> API instance*, and select *Alerts*.
+
