...
The Upstream Idle Timeout policy enables you to set a maximum amount of a time a stream between Flex Gateway and the upstream service can remain idle without receiving any additional requests.
+
