//tag::intro1[]
Anypoint Flex Gateway enables you to configure shared storage for distributed caching, gateway configuration catching (Connected Mode), and rate limiting policies. Redis also provides extra memory for caching.
