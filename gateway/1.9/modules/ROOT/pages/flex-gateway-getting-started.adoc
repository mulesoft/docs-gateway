= Getting Started with Self-Managed Flex Gateway
...
+
image::gateway-quickstart-add-gateway.png["A code block with a command to register a Flex Gateway with Anypoint Platform",width=90%]
