...
include::partial$task-shared-storage-config.adoc[tags=secure-password-intro]

include::partial$task-shared-storage-config.adoc[tags=secure-password-k8s]

include::partial$task-shared-storage-config.adoc[tags=secure-password-docker]
