...
* API Alerts 
+
See xref:flex-use-api-alerts.adoc[].

* Key Metrics
+
See xref:flex-view-api-metrics.adoc[].

For more information about API Manager's support on Hyperforce, see xref:api-manager
