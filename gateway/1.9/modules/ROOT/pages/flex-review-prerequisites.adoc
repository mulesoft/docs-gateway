...
Flex Gateway is designed to run in cloud-native architectures. 
Therefore, multiple installations on a single Linux VM aren't supported. 
You can install only one gateway instance per Linux VM.
