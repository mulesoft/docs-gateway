= Getting Started with Managed Flex Gateway
ifndef::env-site,env-github[]
include::_attributes.adoc[]
endif::[]
:imagesdir: ../assets/images

The goal of this tutorial is to quickly get started with Anypoint Managed Flex Gateway. The tutorial describes how to create and run Managed Flex Gateway. 
...
* Created a private space or have access to a private space created by someone else. To create a private space, see xref::cloudhub-2::ps-create-configure.adoc[].
...
. Click *Save & deploy*.
+
The UI returns to the *Flex Gateways* page.
. In the list of Managed Gateways, find your new gateway and wait until it's status is *Running*.
...
. Select your deplyoed Managed Flex Gateway in the *Select a gateway* section.
. Click *Next*.
+
