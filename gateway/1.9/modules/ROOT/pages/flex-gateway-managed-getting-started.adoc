...
This tutorial guides you through getting started with Anypoint Managed Flex Gateway on CloudHub 2.0. It describes how to create and run Managed Flex Gateway. 

Additionally, the tutorial describes how to publish an API and secure it with a basic authentication policy.
