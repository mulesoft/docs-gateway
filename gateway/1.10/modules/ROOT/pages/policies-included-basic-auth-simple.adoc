...
:page-aliases: api-manager::basic-authentication-simple-concept.adoc, api-manager::basic-authentication-concept.adoc, api-manager::http-basic-authentication-policy.adoc
