...
For deployments using Docker images, add the Flex Gateway Docker image to your local Docker registry to ensure the image is available in the event of a Dockerhub outage.
