...
[NOTE]
====
 You can monitor Managed Flex Gateway configuration actions, such as creating and deleting APIs, by using Access Management audit logs. Audit logs don't require configuration.
