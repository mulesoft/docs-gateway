...
The goal of this tutorial is to quickly get started with Anypoint Omni Gateway. Using Docker, the tutorial describes how to install, register, and run Omni Gateway in Connected Mode. Additionally, the tutorial describes how to publish an API that is secured with a basic authentication policy.
