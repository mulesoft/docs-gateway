...
NOTE: To automate these commands using a Jenkins pipeline, see xref:flex-conn-jenkins-api.adoc[Automate Omni Gateway in Connected Mode Using a Jenkins Pipeline].
...
. xref:flex-{page-mode}-reg-run.adoc[Register and Run Omni Gateway in Connected Mode].
...
+ 
You do not have to xref:flex-conn-reg-run-app.adoc[Register and Run Omni Gateway with a Connected App] to use the API Manager API, but you can use the same Connected App if you include the proper scopes.
