...
* Downloaded Omni Gateway. For more information, see xref:flex-install.adoc[]. 
* Registered Omni Gateway and are running it in Local Mode. For more information, see xref:flex-local-reg-run.adoc[Register and Run in Local Mode]. 
