= Configuring TLS Context for Omni Gateway in Connected Mode
ifndef::env-site,env-github[]
include::_attributes.adoc[]
endif::[]
:imagesdir: ../assets/images
:page-mode: conn
:page-aliases: flex-conn-tls-config.adoc

// Add TLS Context intro
include::partial$task-add-tls-context.adoc[tags=intro1]
...
== Before You Begin
Before configuring the TLS context for an Omni Gateway Connected Mode, complete the following tasks:
...
include::partial$task-add-tls-context.adoc[tags=configurationOptions]


// Add TLS Context in Secrets Manager
include::partial$task-add-tls-context.adoc[tags=addContext]
...
* xref:local-tls-config.adoc[Configuring TLS Context for Omni Gateway in Local Mode]
