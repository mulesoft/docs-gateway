...
NOTE: When using distributed shared storage, cached configurations are lost after gateway restarts. For persistent caching across gateway restarts, use xref:flex-conn-shared-storage-config.adoc[Redis shared storage].
...
Configure either:
+
* xref:flex-conn-distributed-shared-storage-config.adoc[Distributed shared storage]: Cached configurations are lost after gateway restarts
* xref:flex-conn-shared-storage-config.adoc[Redis shared storage]: Cached configurations persist across gateway restarts
