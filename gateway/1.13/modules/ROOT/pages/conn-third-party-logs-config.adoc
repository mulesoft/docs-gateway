= Configuring Omni Gateway Log Output for Third-Party Services
ifndef::env-site,env-github[]
include::_attributes.adoc[]
endif::[]
:imagesdir: ../assets/images
:page-mode: conn
:page-aliases: flex-conn-third-party-logs-config.adoc
...
+
include::partial$task-config-logs-third-party.adoc[tags=docker2;view-logs-conn;configure-message-logging-step]
...
To configure a Message Logging policy, see xref:conn-message-log.adoc[].
...
* xref:local-configuration-reference-guide.adoc#logging[Declarative Configuration Reference Guide]
* xref:conn-message-log.adoc[]
* xref:conn-disable-logs.adoc[]
