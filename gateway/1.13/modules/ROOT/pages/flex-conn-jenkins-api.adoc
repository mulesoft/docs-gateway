...
NOTE: To instead automate your Omni Gateway with the Anypoint CLI, see xref:flex-conn-jenkins-cli.adoc[].
...
* xref:flex-conn-manage-public-api.adoc[Manage Omni Gateway Using the API Manager API]