...
* *Log and mask*: Forwards the request unchanged and logs findings with masked values (replaced with `\***`).
...
[source,json]
----
[accessLog] Request: `Contact me at ***@example.com or call ***. My SSN is ***.` has sensitive data: [
  {
    "pii_type": "Email",
    "masked_value": "***",
    "start": 14,
