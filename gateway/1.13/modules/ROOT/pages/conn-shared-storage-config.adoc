= Configuring Redis Shared Storage for Omni Gateway in Connected Mode
ifndef::env-site,env-github[]
include::_attributes.adoc[]
endif::[]
:imagesdir: ../assets/images
:page-mode: conn
:page-aliases: flex-conn-shared-storage-config.adoc
...
* xref:local-shared-storage-config.adoc[Configuring Shared Storage for Omni Gateway in Local Mode]
