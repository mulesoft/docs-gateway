...
The A2A v1 Agent Card policy also enables the *Total Agent Calls* metric that tracks the total successful and unsuccessful calls made to the agent. To view *Total Agent Calls*, see xref:managed-view-api-metrics.adoc[].
