...
The following examples demonstrate common configurations for the A2A v1 Quality Evaluation policy using different LLM models, timeouts, and endpoint configurations.
...
. Upstream agent returns `200` with completed status:
+
[source,json]
----
{
