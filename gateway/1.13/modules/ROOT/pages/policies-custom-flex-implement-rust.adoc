...
+
For more information on pushing custom policies to Exchange, refer to xref:policies-custom-flex-getting-started.adoc[Publish an Omni Gateway or Mule 4 Custom Policy].
