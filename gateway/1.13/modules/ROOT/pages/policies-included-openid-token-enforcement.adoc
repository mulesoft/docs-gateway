...
>s|Release Notes| xref:release-notes::flex-gateway/omni-gateway-policies/openid-token-enforcement-release-notes.adoc[OpenID Connect OAuth 2.0 Token Enforcement]
