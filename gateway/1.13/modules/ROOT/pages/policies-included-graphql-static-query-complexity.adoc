...
>s|Release Notes| xref:release-notes::flex-gateway/omni-gateway-policies/graphql-static-query-complexity-release-notes.adoc[GraphQL Static Query Complexity]
