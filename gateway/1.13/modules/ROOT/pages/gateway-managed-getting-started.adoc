...
:page-aliases: flex-gateway-managed-getting-started.adoc
...
* Review the xref:review-prerequisites.adoc[] and verify that you have the necessary Managed Omni Gateway permissions.
