...
include::partial$task-rep-run-flex-gateway.adoc[tags=add-omni-rep-byb;add-omni-rep-byb-conn;add-omni-rep1]

include::partial$task-reg-run-flex-gateway.adoc[tags=create-config-folder-file;config-content;linux-start-commands]

include::partial$task-rep-run-flex-gateway.adoc[tags=add-omni-rep2]
