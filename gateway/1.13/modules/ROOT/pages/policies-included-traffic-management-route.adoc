...
>s|Release Notes| xref:release-notes::flex-gateway/omni-gateway-policies/traffic-management-route-release-notes.adoc[Traffic Management for Multiple Upstream Services]
