...
NOTE: Automating your Omni Gateway with Anypoint CLI shares many similarities with Automating your Omni Gateway with the API Manager API. To automate your Omni Gateway using API Manger API requests, see xref:flex-conn-jenkins-api.adoc[].
