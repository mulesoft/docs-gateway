...
| HTML to Markdown | Converts eligible HTML content to Markdown after stripping `<script>` and `<style>` blocks. If the conversion fails, the policy falls back to that stripped HTML instead of erroring. | Disabled
