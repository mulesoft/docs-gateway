...
Every request passes through a deterministic per-session sampler to control Azure costs and latency contribution. The sampler ensures the same actor is always sampled or always skipped — no coverage flapping.
