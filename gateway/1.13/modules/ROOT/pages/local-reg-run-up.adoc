...
// - task overview
include::partial$task-reg-run-flex-gateway.adoc[tags=k8s-install-omni-helm-chart-intro-local]
...
include::partial$task-reg-run-flex-gateway.adoc[tags=k8s-omni-helm-chart-add;k8s-omni-helm-chart-deploy-local]
