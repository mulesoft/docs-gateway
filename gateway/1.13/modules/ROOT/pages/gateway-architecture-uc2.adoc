...
:page-aliases: flex-architecture-uc2.adoc, architecture-uc2.adoc
...
image:ad-uc-2-p-5-physical.png["A detailed view of pattern five, which contains the necessary services to support Omni Gateway"]
...
image:ad-uc-2-p-6-physical.png["A detailed view of pattern six, which contains the necessary services to support Omni Gateway"]
