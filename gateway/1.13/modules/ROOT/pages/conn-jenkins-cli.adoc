= Automating Omni Gateway with a Jenkins Pipeline using Anypoint CLI
ifndef::env-site,env-github[]
include::_attributes.adoc[]
endif::[]
:imagesdir: ../assets/images
:page-mode: conn
:page-aliases: flex-conn-jenkins-cli.adoc

You can use a Jenkins Pipeline to automate the workflow for Omni Gateway in Connected Mode. With a Jenkins Pipeline, you can register and run an Omni Gateway and use features of the Anypoint CLI, such as creating and deploying API instances.
...
NOTE: Automating your Omni Gateway with Anypoint CLI shares many similarities with Automating your Omni Gateway with the API Manager API. To automate your Omni Gateway using API Manger API requests, see xref:conn-jenkins-api.adoc[].
...
After installing Anypoint CLI 4.x, you can create an API instance and deploy it to your Omni Gateway. 
...
Use the following code blocks to archive the registration file and remove the Docker container running Omni Gateway. Add the `post` block in the `pipeline` block after the `stages` block:
