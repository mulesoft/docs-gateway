...
NOTE: If you use xref:policies-included-mcp-progressive-disclosure.adoc[MCP Tools Progressive Disclosure], it must be positioned first, before any access control policies.
