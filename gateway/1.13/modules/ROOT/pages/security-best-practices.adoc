...
To learn how to renew your registration, see xref:gateway-renew-certificate.adoc[].
...
To learn more about how to update your Omni Gateway, see xref:gateway-upgrade.adoc[].
...
NOTE: For guidelines on handling incoming requests from external sources, see xref:gateway-architecture-uc2.adoc[] and xref:gateway-architecture-uc4.adoc[]. 
...
* xref:conn-tls-config.adoc[]
* xref:local-tls-config.adoc[]
...
NOTE: For guidelines on communicating to an internal upstream service, see xref:gateway-architecture-uc1.adoc[] and xref:gateway-architecture-uc3.adoc[].
...
NOTE: For guidelines on communicating to an external upstream service, see xref:gateway-architecture-uc2.adoc[] and xref:gateway-architecture-uc4.adoc[].
