...
:page-aliases: flex-gateway-llm-proxy-semantic-service.adoc, gateway-llm-proxy-semantic-service.adoc
...
+
NOTE: To deny users from asking about certain subjects, create prompt topics for the subjects and apply them as deny list topics when configuring your LLM Proxy.
