= Publish an Omni Gateway Custom Policy
ifndef::env-site,env-github[]
include::_attributes.adoc[]
endif::[]
:page-aliases: policies-custom-flex-getting-started.adoc, policies::policies-custom-flex-getting-started.adoc

include::partial$pdk-banner.adoc[tag=pdk]

The following steps are the high-level workflow for publishing custom policies for Omni Gateway:
...
Before you can publish a custom policy for Omni Gateway, ensure you have administrator or contributor permission for Anypoint Platform.
...
The implementation binary file is a JAR file for Mule 4 policies or a WebAssembly WASM file for Omni Gateway. These files should support all of the configuration fields and function the way the definition metadata describes.
