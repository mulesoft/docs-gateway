...
To apply a Message Logging policy, see xref:flex-gateway-secure-local.adoc[] and use the xref:gateway::policies-included-message-logging.adoc[Message Logging Configuration Parameters].
