...
>s|Release Notes| xref:release-notes::flex-gateway/omni-gateway-policies/json-threat-protection-release-notes.adoc[JSON Threat Protection Policy]
...
NOTE: The JSON Threat Protection policy doesn't support multi-part form requests.
