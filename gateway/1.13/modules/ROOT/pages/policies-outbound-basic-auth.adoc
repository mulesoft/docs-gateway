...
>s|Release Notes| xref:release-notes::flex-gateway/omni-gateway-policies/outbound-basic-auth-release-notes.adoc[Credential Injection Basic Authentication]
