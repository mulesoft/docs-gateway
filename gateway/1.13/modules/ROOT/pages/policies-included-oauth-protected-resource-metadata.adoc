...
IMPORTANT: Only apply this policy to the `/.well-known/oauth-protected-resource` route. Requests to paths that don't match the well-known segment receive a `404 Not Found` response.
