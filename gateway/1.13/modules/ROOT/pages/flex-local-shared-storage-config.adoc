= Configuring Shared Storage for Omni Gateway in Local Mode
...
* xref:flex-conn-shared-storage-config.adoc[Configuring Shared Storage for Omni Gateway in Connected Mode]
