...
:page-aliases: flex-troubleshoot-requests.adoc
...
image:inbound-outbound-requests.png[Inbound connections are between the client and Omni Gateway and outbound connections are between Omni Gateway and the upstream service, align=center]
