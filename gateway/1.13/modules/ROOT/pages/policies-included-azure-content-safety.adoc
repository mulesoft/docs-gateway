...
>s|Release Notes| xref:release-notes::gateway/policies/azure-content-safety-release-notes.adoc[]
...
* xref:general::model-proxy.adoc[Model Proxy]
* xref:general::model-proxy-policies.adoc[Model Proxy Policies]
