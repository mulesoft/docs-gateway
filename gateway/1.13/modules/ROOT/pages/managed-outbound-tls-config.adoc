...
:page-mode: conn
:page-aliases: flex-managed-outbound-tls-config.adoc
...
include::partial$task-add-tls-context.adoc[tags=redeploy]
//Redeploy

//Ciphers
include::partial$tls-cipher.adoc[tags=connectedSelect;cipherSupport;ciphers]
