...
image:flex-istio-deployment.png["A diagram demonstrating the architecture to integrate Omni Gateway with Istio"]
...
* xref:flex-install.adoc#kubernetes[Download Omni Gateway for Use in a Kubernetes Cluster]
