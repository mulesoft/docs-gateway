...
. From the side navigation panel, click *Policies*.
. Click the more options button (image:more-options-menu.png[1%,1%]) of the policy to upgrade, and then click *Edit configuration*.
...
. From *API Instances* or *Agent and Tool Instances*, click the name of the instance with the policy to upgrade.
. From the side navigation panel, click *Policies*.
. Click the more options button (image:more-options-menu.png[1%,1%]) of the policy to upgrade, and then click *Check for implementation updates*.
