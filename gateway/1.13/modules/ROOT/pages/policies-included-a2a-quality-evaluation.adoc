...
>s|Release Notes| xref:release-notes::gateway/policies/a2a-quality-evaluation-release-notes.adoc[]
...
* xref:policies-included-a2a-prompt-decorator.adoc[]
* xref:policies-included-a2a-pii-detector.adoc[]
* xref:policies-included-a2a-token-rate-limit.adoc[]
