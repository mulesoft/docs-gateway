...
>s|Release Notes| xref:release-notes::flex-gateway/omni-gateway-policies/header-removal-release-notes.adoc[Header Removal]
...
.Inbound Header
image::remove-inbound-header.png["Removed headers at the start of message processing"]
