...
:page-aliases: flex-gateway-uninstall.adoc
...
. To confirm that Omni Gateway is uninstalled, run the `docker ps` command again. The uninstalled container no longer appears in the list.
