= Publishing a Simple API Instance in Local Mode
ifndef::env-site,env-github[]
include::_attributes.adoc[]
endif::[]
:imagesdir: ../assets/images
:page-aliases: flex-local-publish-simple-api.adoc

Publish a simple API running behind Omni Gateway in Local Mode, modifying YAML configuration data by one of the following methods:
...
A simple API is now running behind Omni Gateway.
