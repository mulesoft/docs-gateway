...
API Manager and Anypoint Monitoring collect metrics on active Omni Gateway API instances. You can view charts related to these metrics and filter the data by date. 
...
[NOTE]
====
The *Mule API Analytics* tab in API Manager is currently not available for Omni Gateway APIs. Use the *Key Metrics* or the additional metrics in Anypoint Monitoring.
====
