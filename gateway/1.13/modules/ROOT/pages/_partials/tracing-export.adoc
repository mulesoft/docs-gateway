...
To export traces to third-party providers using the Anypoint Monitoring Telemetry Exporter, see xref:monitoring::telemetry-exporter.adoc[Exporting telemetry data to third-party monitoring systems].
