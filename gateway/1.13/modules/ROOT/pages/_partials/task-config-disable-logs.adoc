...
* Depending on your output, ensure that the service where you direct logs to is operational. For more information about log output services, refer to xref:{page-mode}-third-party-logs-config.adoc[Configuring Omni Gateway Output for Third-Party Services].
...
* xref:{page-mode}-third-party-logs-config.adoc[Configuring Omni Gateway Output for Third-Party Services]
* xref:policies-included-message-logging.adoc[]
* xref:{page-mode}-reg-run.adoc[Registering and Running Omni Gateway]
//end::see-also[]
