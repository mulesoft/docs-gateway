...
Configure Redis shared storage if persistant storage after gateway restarts is required. If persitant shared storage isn't required, xref:flex-{page-mode}-distributed-shared-storage-config.adoc[configure distributed shared storage].
