...
[[select-ciphers]]
== Select Ciphers
:page-aliases: flex-tls-cipher.adoc
...
== TLS Cipher Support on Omni Gateway
...
| TLS RSA WITH AES 128 CBC SHA | 1.2 | No | Weak
| TLS RSA WITH AES 256 CBC SHA | 1.2 | No | Weak
| TLS PSK WITH AES 128 CBC SHA | 1.2 | No | Weak
| TLS PSK WITH AES 256 CBC SHA | 1.2 | No | Weak
| TLS ECDHE ECDSA WITH AES 128 CBC SHA | 1.2 | No | Weak
| TLS ECDHE ECDSA WITH AES 256 CBC SHA | 1.2 | No | Weak
| TLS ECDHE RSA WITH AES 128 CBC SHA | 1.2 | No | Weak
| TLS ECDHE RSA WITH AES 256 CBC SHA | 1.2 | No | Weak
| TLS ECDHE PSK WITH AES 128 CBC SHA | 1.2 | No | Weak
| TLS ECDHE PSK WITH AES 256 CBC SHA | 1.2 | No | Weak
|===
...
| TLS_RSA_WITH_AES_128_CBC_SHA | 1.2 | No | Weak
| TLS_RSA_WITH_AES_256_CBC_SHA | 1.2 | No | Weak
| TLS_PSK_WITH_AES_128_CBC_SHA | 1.2 | No | Weak
| TLS_PSK_WITH_AES_256_CBC_SHA | 1.2 | No | Weak
| TLS_ECDHE_ECDSA_WITH_AES_128_CBC_SHA | 1.2 | No | Weak
| TLS_ECDHE_ECDSA_WITH_AES_256_CBC_SHA | 1.2 | No | Weak
| TLS_ECDHE_RSA_WITH_AES_128_CBC_SHA | 1.2 | No | Weak
| TLS_ECDHE_RSA_WITH_AES_256_CBC_SHA | 1.2 | No | Weak
| TLS_ECDHE_PSK_WITH_AES_128_CBC_SHA | 1.2 | No | Weak
| TLS_ECDHE_PSK_WITH_AES_256_CBC_SHA | 1.2 | No | Weak
|===
