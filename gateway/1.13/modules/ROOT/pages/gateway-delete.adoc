= Delete an Instance of Self-Managed Omni Gateway
ifndef::env-site,env-github[]
include::_attributes.adoc[]
endif::[]
:imagesdir: ../assets/images
:page-aliases: flex-gateway-delete.adoc, runtime-manager::flex-gateway-delete.adoc
...
|Running |Gateway is connected to the platform, and you can add APIs to it.
|Not Running |Gateway is not connected to the platform.
...
[NOTE]
If you delete a gateway, you lose its configuration history and can't recover it.
