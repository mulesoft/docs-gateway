...
The following steps are the high-level workflow for publishing custom policies for Anypoint Omni Gateway:
...
The implementation binary file is a JAR file for Mule 4 policies or a WebAssembly WASM file for Anypoint Omni Gateway. These files should support all of the configuration fields and function the way the definition metadata describes.
