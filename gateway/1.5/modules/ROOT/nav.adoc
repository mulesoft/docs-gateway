...
*** xref:policies-pdk-prerequisites.adoc[Prerequisites]
...
**** xref:policies-pdk-simple-oauth2-policy.adoc[Simple OAuth 2.0 Validation]
**** xref:policies-pdk-caching-policy.adoc[Data Chaching]
