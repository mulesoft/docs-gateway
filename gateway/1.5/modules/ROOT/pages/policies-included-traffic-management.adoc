...
[NOTE]
====
The following document applies only to Flex Gateway running in Local Mode. To configure multiple upstream services for Flex Gateway running in Connected Mode, see xref:api-manager::create-instance-task-flex.adoc#traffic-management[Multiple Upstreams for Flex Gateway Running in Connected Mode].
====
