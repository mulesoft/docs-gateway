...
== Using CLI Commands to Renew and Verify Registration
...
The command extracts registration information you can use to verify whether the `renew` command was successful.
...
The `flexctl` CLI provides two methods to verify your registration:

* <<inspect-with-custom-url,Method 1: Verify Registration Status with an Admin API URL>>
* <<inspect-with-reg-file,Method 2: Verify Registration Status with a Registration File>>

[NOTE]
====
If you run `flexctl registration inspect` without flags, the command inspects registration status by using the default Admin API URL.
====

[[inspect-with-custom-url]]
==== Method 1: Verify Registration Status with an Admin API URL
...
==== Method 2: Verify Registration Status with a Registration File
