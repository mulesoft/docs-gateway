...
* You can verify (inspect) renewal by the default method, or you can specify your existing registration file. If you run the `inspect` command without flags, the command inspects registration status by using the default method.
