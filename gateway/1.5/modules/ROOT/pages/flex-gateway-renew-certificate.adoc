...
NOTE: If the location of the created registration file differs from the runtime registration file location, you must copy the newly created file to the runtime registration file location.
