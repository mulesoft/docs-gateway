...
. Replace `<path-to-registration-file-in-container>` with the path and filename of the existing `registration.yaml` file. For Flex Gateway running in a container, you must specify the file in the container file system.
...
As a Docker example, if `/home/user/flex/registration.yaml` contains your current registration file, navigate to `/home/user/flex/` and run the following command with your Anypoint Platform credentials:
...
As a Docker example, if `/home/user/flex/registration.yaml` contains your current registration file, navigate to `/home/user/flex/` and run the following command with your connected app credentials:
