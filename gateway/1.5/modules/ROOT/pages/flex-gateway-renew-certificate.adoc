...
Renewing Flex Gateway registration ensures the continued operation of your applications. You renew registration by using the `flexctl registration renew` CLI.
