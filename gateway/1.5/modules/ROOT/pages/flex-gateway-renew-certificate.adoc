...
For inspecting the Flex Gateway Admin API registration using Docker, invoke `flexctl` commands as part of `docker exec`. Replace `<container-name-or-id>` with the running container reference. For example:
