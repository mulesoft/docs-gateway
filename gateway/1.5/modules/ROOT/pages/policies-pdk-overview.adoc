...
Policies enforce regulations to help manage security, control traffic, and improve API adoption. Flex Gateway provides many xref:policies-included-directory.adoc[included policies], but they might not cover all your specific business needs.
...
In case you are facing obstacles at some phase of your Custom Policy development lifecycle, take a look at the xref:policies-pdk-troubleshooting.adoc[PDK troubleshooting guide] to see a possible solution to the presented issue. 
