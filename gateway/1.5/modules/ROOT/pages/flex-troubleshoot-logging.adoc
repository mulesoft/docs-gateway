...
+
Potential configuration errors may appear similar to the following:
+
----
...
. Regardless of if configuration errors appear in the runtime logs, view the `/var/tmp/mulesoft/flex-gateway/fluent-bit.conf` file to ensure your configuration values are correct.
