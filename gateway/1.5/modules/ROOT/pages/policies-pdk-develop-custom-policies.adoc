...
After installing the xref:policies-pdk-prerequisites.adoc[Prerequisites], you can develop custom policies by using the Policy Development Kit (PDK).
...
+
Publish your policy on Exchange to distribute a beta version of your policy for testing with your Flex Gateway configuration. To deploy a policy to Flex Gateway, see step 8.
