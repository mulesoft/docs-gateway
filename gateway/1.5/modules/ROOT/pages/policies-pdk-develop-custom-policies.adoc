...
The custom policy lifecycle consists of the following docs that explain all steps of developing a custom policy that occur in the Policy Development Kit (PDK). After you xref:policies-pdk-create-project.adoc[Create a New Project], you can complete the steps out of order, for example, when debugging a policy you need to return to the configure policy feature or define a schema definition steps.

After you publish your policy to Exchange, you can debug your policy using 
