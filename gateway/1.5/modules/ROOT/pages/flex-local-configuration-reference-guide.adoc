...
Both policy binding resources and inline policy bindings support environment variables in `config` fields. The environment variables available are dependent on you environment.
