...
The `config` section of policy resource bindings supports environment variables. The environment variables available are dependent on you environment.

To reference your environment variable, type your environment variable prefixed by `$`, for example:
