...
* xref:gateway::policies-included-tls.adoc[Transport Layer Security Policy - Inbound]
* xref:gateway::policies-included-tls-outbound.adoc[Transport Layer Security Policy - Outbound]
