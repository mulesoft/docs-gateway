...
Additionally, depending on your output, ensure that the service where you direct logs to is operational and that you have collected the necessary information:
