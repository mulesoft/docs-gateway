...
Additionally, depending on your output, ensure that the service where you are directing logs to is operational and you have collected the necessary information:
