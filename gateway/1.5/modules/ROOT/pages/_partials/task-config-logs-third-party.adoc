...
Additionally, depending on your output, ensure that the service where you are directing logs to is operational and that you have collected the necessary information:
...
+
For additional troubleshooting help, see xref:flex-troubleshoot-log.adoc[].
//end::view-logs-conn[]
