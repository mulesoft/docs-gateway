...
[cols="1a,1a"]
|===
|image:install-docker-logo.png[15%,15%,xref="#install-docker"]
|image:install-podman-logo.png[12%,12%,xref="#install-podman"]
...
* <<install-k8s-docker,Docker>>
* <<install-k8s-podman,Podman>>
...
* <<install-openshift-docker,Docker>>
* <<install-openshift-podman,Podman>>
