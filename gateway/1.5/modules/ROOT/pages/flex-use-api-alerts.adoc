...
On the following table you can learn the amount and type of alerts per API instance.

[%header%autowidth.spread]
|===
| User | Non-Active Alerts | Active Alerts
...
NOTE: Alerts are enabled by default when they are created. This setting cannot be modified.
