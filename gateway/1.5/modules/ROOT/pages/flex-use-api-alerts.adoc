...
The following table explains the amount and types of alerts per API instance:

[%header%autowidth.spread]
|===
|Subscription | Non-Active Alerts | Active Alerts
| Gold | No limit | Up to 6
| Platinum | No limit | Up to 6
| Titanium | No limit | Up to 10
|===
...
Alerts are enabled by default when they are created and this setting cannot be modified.
