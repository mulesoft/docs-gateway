...
You are required to create an alert for the Health Check policy. Applying the policy navigates you to the Create Alert page, where you must create an alert. For about how to configure your alert, visit xref:flex-use-api-alerts.adoc[Using Flex Gateway API Alerts].
