...
For HTTP authorization servers, you can configure what headers are appended, overwritten, or ignored. Policies with an HTTP server configured can also modify the client response returned from the upstream service. 
