...
[[install-rhel-ibm]]
[discrete]
==== image:install-rhel-ibm-logo.png[5%,5%] Red Hat Enterprise Linux on IBM Power Systems

.Download and install Flex Gateway as a Red Hat Enterprise Linux service on IBM Power PC Architecture
[%collapsible]
====
