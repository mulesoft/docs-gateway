...
.Download and install Flex Gateway as an RHEL service
[%collapsible]
====
...
[[install-rhel-ibm]]
[discrete]
==== image:install-rhel-ibm-logo.png[5%,5%] Red Hat Enterprise Linux / IBM Power Systems

.Download and install Flex Gateway as an RHEL/IBM service
[%collapsible]
====
...
Flex Gateway runs on the following Long Term Support (LTS) versions of RHEL/IBM:
