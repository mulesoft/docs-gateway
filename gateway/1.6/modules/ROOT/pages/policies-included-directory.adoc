...
| xref:policies-included-traffic-management.adoc[Traffic Management for Multiple Upstream Services] | Manages API instance traffic to multiple upstream services from a single consumer endpoint
| xref:policies-included-traffic-management-single.adoc[Traffic Management for Single Upstream Service] | Manages API instance traffic to a single upstream service from a single consumer endpoint
