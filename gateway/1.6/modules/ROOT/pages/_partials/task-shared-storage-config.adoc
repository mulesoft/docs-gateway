...
Redis Sentinel provides high availability for Redis shared storage when not using a Redis Cluster

For more information about Redis Sentinel, see https://redis.io/docs/management/sentinel/[Redi Sentinel^].
