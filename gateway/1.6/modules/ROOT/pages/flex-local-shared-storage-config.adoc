...
include::partial$task-shared-storage-config.adoc[tags=intro1;intro2;icon-table;byb;linux;sample-config-all-intro,sample-config-all]
...
+
include::partial$task-shared-storage-config.adoc[tags=docker-config-file-step;sample-config-all-intro,sample-config-all]

//configure shared storage for Flex Gateway in a Kubernetes cluster
include::partial$task-shared-storage-config.adoc[tags=k8s;sample-config-all-intro,sample-config-all]
