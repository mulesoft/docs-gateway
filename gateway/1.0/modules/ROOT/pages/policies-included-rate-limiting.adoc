...
// :page-aliases: api-manager::rate-limiting.adoc, api-manager::rate-limiting-and-throttling.adoc, policies::policies-included-rate-limiting.adoc
...
Distributed Rate Limit requires Shared Storage to be enabled.
