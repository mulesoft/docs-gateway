...
In pattern eight, Flex Gateway acts as an intermediary between two organization external entities. Flex Gateway runs as an ingress and egress controller that applies secure communication and policy enforcement.
