...
Refer to xref:policies-automated-overview.adoc[Automated Policies] and xref:policies::policies-resource-level-overview.adoc[Resource-Level Policies] for more information.
