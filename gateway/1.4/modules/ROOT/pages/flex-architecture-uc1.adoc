...
== Pattern 1: Org Internal API Exposed to Org Internal Consumer
...
== Pattern 1A: Internal Org API Exposed to Internal Org Consumer Using the Same Vpc or Network
...
image:ad-uc-1-p-1b-seprate-clusters.png[A detailed view of pattern 1A containing the necessary services to support Flex gateway] 
...
The following diagram demonstrates the physical implementation of Org Internal API exposed to Org External Consumer on Kubernetes. The diagram assumes that the firewall terminates the incoming external mTLS connection.
...
The following diagram demonstrates the physical implementation of External Org API exposed to an Internal Org Consumer on Kubernetes. The diagram assumes that the firewall terminates the incoming external mTLS connection.
