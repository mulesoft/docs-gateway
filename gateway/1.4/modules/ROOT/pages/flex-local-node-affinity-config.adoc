= Configure the Selection of Kubernetes Nodes for Pods Containing Flex Gateway (Node Affinity)
...
include::partial$task-node-affinity.adoc[tags=flex-node-affinity-list-labels]
