...
* xref:api-manager::create-instance-task.adoc[Add an API Instance in API Manager] - An API Instance is an instantiation of an API that describes the configuration of the deployed API.
