...
The following tutorial describes how to install, register, and run Anypoint Flex Gateway in Connected Mode, using Docker. Additionally, the tutorial describes how to publish an API that is secured with a basic authentication policy.
