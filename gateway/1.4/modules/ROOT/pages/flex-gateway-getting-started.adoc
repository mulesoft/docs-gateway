...
+
image::gateway-quickstart-add-new-api.png["Add new API page",width=35%]
...
. Click *Next*.
. In the *Endpoint* page, enter the following in the *Implementation URI* field:
+
[source]
----
...
+
image::gateway-quickstart-add-policy.png["Add Policy page",width=65%]
...
+
image::gateway-quickstart-config-basic-auth.png["Configure Basic Authentication Policy page",width=65%]
