...
A Forward Proxy allows you to route all Flex Gateway connections through a single proxy connection. This allows you to isolate Flex Gateways to an internal network.


Add a Forward Flex Gateway in Local Mode, modifying YAML configuration data by the following method:
