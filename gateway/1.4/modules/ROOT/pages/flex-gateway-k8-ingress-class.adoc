...
Ingress controllers are defined by using `IngressClass` resources. By default, a Flex Gateways deployed on Kubernetes in Local Mode is defined as `IngressClass` resources.
