...
Applying policies and other configuration options to your Flex Gateway can slow performance. Increase replica CPU and memory for higher throughput and increased performance.
