...
* A minimum of either Kubernetes 1.22 or OpenShift 4.8.
...
Applying policies and other configuration options to your Flex Gateway can reduce performance. Increase replica CPU and memory for higher throughput and increased performance.
