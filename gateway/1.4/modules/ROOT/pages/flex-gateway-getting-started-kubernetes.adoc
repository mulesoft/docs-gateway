...
This procedure is a prerequisite to registering the Flex Gateway image with Anypoint Platform in <<register-flex>> and _is not_ used by the gateway deployment through Helm in <<deploy-flex>>. 
