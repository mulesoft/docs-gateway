...
This procedure is a prerequisite to registering the Flex Gateway image with Anypoint Platform in <<register-flex>>. Registration is required during the gateway deployment through Helm in <<deploy-flex>>. 
