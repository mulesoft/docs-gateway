...
* Confirm that your Kubernetes cluster is available by following the steps in <<check-cluster>>.
* Review <<k8-cluster-reqs>> if you have not done so already. These prerequisites help avoid deployment errors. 
