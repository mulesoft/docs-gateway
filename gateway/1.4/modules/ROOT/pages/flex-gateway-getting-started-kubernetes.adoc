...
+
To avoid deployment errors in this guide, your cluster must support this process. However, note that Flex Gateway supports all of the following Ingress Controller services: `ClusterIP`, `NodePort`, `LoadBalancer` (default), `ExternalName`. 
