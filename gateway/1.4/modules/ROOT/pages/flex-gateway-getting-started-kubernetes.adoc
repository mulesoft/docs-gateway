...
Get started with Anypoint Flex Gateway on a Kubernetes cluster. Set up a Flex Gateway deployment that connects to Anypoint Platform, and use the deployment to control traffic to an API implementation. This guide covers the following high-level tasks:
