...
Get started with Anypoint Flex Gateway on a Kubernetes cluster. Set up a Flex Gateway container that connects to Anypoint Platform, and use the container to control traffic to an API implementation. This guide covers the following high-level tasks:
