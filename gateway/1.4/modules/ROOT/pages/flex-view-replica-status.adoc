...
|Disconnected |The replica is not connected to the platform. There is no information on whether it is serving traffic. Disconnected replicas are not shown in Runtime Manager after seven days.
|===
