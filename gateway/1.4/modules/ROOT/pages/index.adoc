...
A single Flex Gateway can support multiple backend APIs. To support more backend APIs, you can choose to deploy multiple replicas or additional Flex gateways. Increase Replica CPU and memory for higher throughput and better performance.
...
See also, xref:flex-gateway-k8-overview.adoc[].
