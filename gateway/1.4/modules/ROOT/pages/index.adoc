...
A single replica can support {gateway-api-max} backend APIs. To support more backend APIs, you can deploy multiple replicas or additional Flex Gateway instances.
