...
A single replica can support {gateway-api-max} backend APIs. If you need to support more backend APIs, you can use multiple replicas or additional Flex Gateways.
