...
Flex Gateway is distributed as a standard package. Use the following steps to upgrade or downgrade Flex Gateway to a specific version or the latest version. 
