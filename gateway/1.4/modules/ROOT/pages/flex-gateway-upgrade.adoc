...
Flex Gateway is distributed as a standard package. Use the following steps to either configure Flex Gateway to a specific version
or to upgrade the latest version. 

To list the aviable versions on Flex Gateway:
[source,ssh]
----
