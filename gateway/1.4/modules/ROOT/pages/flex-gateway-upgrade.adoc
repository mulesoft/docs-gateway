...
[cols="1a,1a,1a"]
|===
|image:install-linux-logo.png[20%,20%,xref="flex-gateway-upgrade.adoc#linux"]
|image:install-docker-logo.png[25%,25%,xref="flex-gateway-upgrade.adoc#docker"]
|image:install-kubernetes-logo.png[20%,20%,xref="flex-gateway-upgrade.adoc#k8"]

|xref:flex-gateway-upgrade.adoc#linux[Upgrade as a Linux Service]
|xref:flex-gateway-upgrade.adoc#docker[Upgrade in a Docker Container]
|xref:flex-gateway-upgrade.adoc#k8[Upgrade as a Kubernetes Ingress Controller]
|===
...
[[k8]]
== Upgrade on a Kubernetes Cluster
