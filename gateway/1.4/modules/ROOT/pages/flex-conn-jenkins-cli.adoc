...
After installing registering and running your Flex Gateway, you to create an API instance and deploy it to your Flex Gateway. 

You can repeat this step to add multiple API instances. For additional API configuration flags, see xref:4.x@anypoint-cli::api-mgr.adoc#api-mgr-api-manage[].
