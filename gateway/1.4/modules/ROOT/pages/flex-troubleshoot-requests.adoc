...
Isolating the connection between the API upstream and Flex Gateway allows you to test for connection issues between the two.
...
Isolating the connection between the Flex Gateway and the client allows you to test if the connection issue is due to a load balancer or another system added between the gateway and the client.
