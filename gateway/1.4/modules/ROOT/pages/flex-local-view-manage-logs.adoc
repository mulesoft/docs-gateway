...
You can enable more detailed logs to troubleshoot problems by configuring the `debug` parameter. As an example, the following definition specifies a `spec.logging.runtimeLogs.logLevel` value of `debug`:
