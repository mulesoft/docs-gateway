...
As well as being able to configure additional logging outputs, Flex Gateway maintains `flex-gateway-fluent` runtime and access logs. You do not need to configure these logs. To view `flex-gateway-fluent` logs, see <<view-logs, View Logs>>.
