= Configuring TLS and mTLS Context for Flex Gateway in Connected Mode
...
include::anypoint-security::partial$task-flex-add-tls-context.adoc[tags=mTLS;redeploy]
//Redeploy
