...
+
Depending on your desired configuration, you must add either a PEM Type Keystore or a PEM Type Truststore to your secret group. Complete the following task for your configuration:
