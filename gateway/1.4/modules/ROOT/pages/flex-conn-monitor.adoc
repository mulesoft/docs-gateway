...
* xref:flex-view-replica-status.adoc[View Replica Status in Runtime Manager] - View Flex Replica connection status from within the Runtime Manager UI.
* xref:flex-view-api-status.adoc[View Flex Gateway API Status in Runtime Manager] - View Flex Gateway API status from within the Runtime Manager UI.
