...
|xref:flex-local-reg-run-app.adoc#linux[Register and Run with a Connected App as a Linux Service]
|xref:flex-local-reg-run-app.adoc#docker[Register and Run with a Connected App in a Docker Container]
|xref:flex-local-reg-run-app.adoc#k8[Register and Run With a Connected App on a Kubernetes Cluster]
|===
