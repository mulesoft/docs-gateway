...
Using a Jenkins pipeline, you can automate the work flow for Flex Gateway in Connected Mode. With a Jenkins pipeline, you can register and run a Flex Gateway and utilize features of the https://anypoint.mulesoft.com/exchange/portals/anypoint-platform/f1e97bc6-315a-4490-82a7-23abe036327a.anypoint-platform/api-manager-api/[API Manager API] such as creating and deploying API instances.
...
Since the commands in the Jenkins pipeline reuses some parameters, it is helpful to define them at the beginning of your work flow.
