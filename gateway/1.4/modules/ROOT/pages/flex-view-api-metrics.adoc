...
[NOTE]
====
API analytics metrics are currently not available for Flex Gateway APIs. Use xref:monitoring::index.adoc[Anypoint Monitoring] to view Flex Gateway API metrics.
====
