...
[NOTE]
====
The *Mule Analytics* tab in API Manager is currently not available for Flex Gateway APIs. Use the *Key Metrics* or the additional metrics in Anypoint Monitoring.
====
