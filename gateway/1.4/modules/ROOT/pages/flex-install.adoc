...
Download and install Flex Gateway as a Linux service, or download the Flex Gateway image from the Docker registry. Downloading is a prerequisite to registering and running a gateway in a Linux service, Docker container, Kubernetes cluster, or OpenShift cluster.
