...
You can install Flex Gateway as a Linux service, in a Docker container, or in a Kubernetes cluster.
...
//TODO: Is "Ingress Controller" true here for k8 and OpenShift? 
//This page is for connected and local modes.  
...
[[install-kubernetes]]
//TODO: "Ingress Controller" for _every_ installation case? 
== Install in a Kubernetes Ingress Controller
