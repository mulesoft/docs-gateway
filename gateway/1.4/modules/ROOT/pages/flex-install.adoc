...
Download and install Flex Gateway as a Linux service, or download the Flex Gateway image from the Docker registry. Downloading is a prerequisite to registering and running a gateway in a Docker container, a Kubernetes cluster, or an OpenShift cluster.
