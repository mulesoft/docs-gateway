...
|xref:flex-gateway-uninstall.adoc#linux[Uninstall as a Linux Service]
|xref:flex-gateway-uninstall.adoc#docker[Uninstall in a Docker Container]
|xref:flex-gateway-uninstall.adoc#k8[Uninstall as a Kubernetes Ingress Controller]
|===
