...
You can manage Flex Gateway in connected mode using the API Manager API instead of the API Manager user interface.
...
To make calls using the API Manager API, you must obtain an authorization token before making calls. To obtain an authorization token make the following API request to the Anypoint Platform:
