...
You can manage Flex Gateway in connected mode using the https://anypoint.mulesoft.com/exchange/portals/anypoint-platform/f1e97bc6-315a-4490-82a7-23abe036327a.anypoint-platform/api-manager-api/[API Manager API] in the https://anypoint.mulesoft.com/exchange/portals/anypoint-platform/[Anypoint Platform Developer Portal] instead of the using Anypoint Platform API Manager user interface. This allows you to automate deployment through the command line.
...
The prerequisites for registering and running with a connected app are:

* xref:service-mesh::obtain-connected-apps-credentials.adoc[Configure a Connected App]:
** To use API Manager API, you must configure your connected app using the *App acts on its behalf (client credentials)* type and include the following scopes:
+
API Manager:
...
To make calls using the API Manager API, you must obtain an authorization token before making calls. To obtain an authorization token:
