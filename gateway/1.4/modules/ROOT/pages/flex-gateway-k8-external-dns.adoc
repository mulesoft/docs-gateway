...
Use ExternalDNS to expose your an application or service on your Kubernetes cluster through a domain name instead of a difficult-to-understand external IP or random host name. 
