...
As the following diagram shows, external traffic in a sidecar deployment passes through Flex Gateway and then to their respective consumer API. Additionally, the consumer application can belong to the same network as Flex Gateway.
