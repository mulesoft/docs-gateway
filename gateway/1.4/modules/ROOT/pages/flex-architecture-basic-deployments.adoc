...
== Sidecar Deployment
In a sidecar deployment, you deploy Flex Gateway in the same pod as the service that it is protecting. Each Flex Gateway deployment exclusively protects the APIs exposed by its protected service. A new Flex Gateway replica is added with each new protected service. 
