...
----
+
This example displays settings from `REVISION` number `2`. The output displays only revisions to values of the settings. If your deployment has always used the default Helm chart values, _no_ revisions appear in the output. 
