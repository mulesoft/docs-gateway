...
If the Redis shared storage service is avaliable locally, a mutual authentication Transport Layer Security (mTLS) connection is not required to communicate with the shared storage. 
