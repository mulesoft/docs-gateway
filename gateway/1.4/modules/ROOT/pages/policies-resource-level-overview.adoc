...
:page-aliases: api-manager::policies-policy-level.adoc, api-manager::resource-level-policies-about.adoc, policies::policies-resource-level-overview.adoc
...
// You can apply multiple conditions to filter your resources and HTTP methods using the xref:policies::policies-resource-level-config-uri-regex.adoc[URI template regex] to any number of methods in your API.
...
// * xref:policies::policies-resource-level-disable-outbound.adoc[]
