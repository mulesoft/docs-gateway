...
|<<linux,Configure Log Output for Flex Gateway as a Linux Service>>
|<<docker,Configure Log Output for Flex Gateway in a Docker Container>>
|<<kubernetes,Configure Log Output for Flex Gateway on a Kubernetes Cluster>>
|===
...
[[kubernetes]]
== Configure Log Output for Flex Gateway on a Kubernetes Cluster
