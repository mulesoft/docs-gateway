...
Additionally, depending on your output, ensure the service where you are directing logs to is operational. For Splunk, you must configure:
...
=== Access Logs
Access logs describe incoming interaction with Envoy over a period of time and incoming requests and response for specific APIs. 
