...
If no events appear in the Splunk dashboard, inspect the Flex Gateway `flex-gateway-fluent` standard output logs to determine if there are configuration errors.
