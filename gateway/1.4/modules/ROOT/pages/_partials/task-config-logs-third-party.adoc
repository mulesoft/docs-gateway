...
//end::intro1[]
//tag::intro2[]
The following example demonstrates how to redirect Flex Gateway logs to Splunk. However, you can use any {fluentbit-ver-var} output. For more information about other output types, see https://docs.fluentbit.io/manual/v/1.8/pipeline/outputs[Fluent Bit Outputs documentation ^]. 
//end::intro2[]
//tag::icon-table[]
