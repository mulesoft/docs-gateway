...
//end::intro1[]
//tag::intro2[]
You can configure TLS either for a specific API Instance or for all API Instances running on your Flex Gateway.
...
* Regular TLS between a client and the API Instance (HTTPS)
* Inbound mutual authentication TLS (mTLS) between an API Instance and a client
* Outbound mTLS between an API Instance and an upstream service
