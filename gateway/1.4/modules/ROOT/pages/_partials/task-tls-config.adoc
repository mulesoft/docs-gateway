...
//tag::sample-config-tls-outbound-insecure-intro[]
*Sample configuration for adding outbound TLS with no certificate validation:*
//end::sample-config-tls-outbound-insecure-intro[]
//tag::sample-config-tls-outbound-insecure[]
[source,yaml]
----
apiVersion: gateway.mulesoft.com/v1alpha1
kind: PolicyBinding
metadata:
  name: tls-outbound-insecure
spec:
  targetRef:
    name: ingress-test-outbound-upstream
    kind: Service
  ...
  config:
    skipValidation: true
----
//end::sample-config-tls-outbound-insecure[]

//tag::sample-config-tls-outbound-oneway-intro[]
*Sample configuration for one-way outbound TLS:*
//end::sample-config-tls-outbound-oneway-intro[]
//tag::sample-config-tls-outbound-oneway[]
[source,yaml]
----
apiVersion: gateway.mulesoft.com/v1alpha1
kind: PolicyBinding
...
spec:
  ...
  config:
    trustedCA: |
      ...
      # -----END CERTIFICATE-----
----
//end::sample-config-tls-outbound-oneway[]

//tag::sample-config-mtls-intro[]
*Sample configuration for one-way outbound mTLS:*
//end::sample-config-mtls-intro[]
//tag::sample-config-mtls[]
[source,yaml]
----
