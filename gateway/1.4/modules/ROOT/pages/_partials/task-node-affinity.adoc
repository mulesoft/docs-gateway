...
. Specifying rules and conditions in a YAML configuration file for the Pod (a Pod specification) that contains your containerized Flex Gateway application (see <<set_node_affinity>>).
