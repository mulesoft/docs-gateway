...
Configure node affinity rules within a Pod specification (Pod spec). A Pod spec is YAML file in which you can specify rules for required, preferred, or both types of matching:
