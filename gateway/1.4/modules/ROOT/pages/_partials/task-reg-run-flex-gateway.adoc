...
IMPORTANT: Create a new directory and then run the registration command in this new directory. Your registration files are stored where you run the command.
