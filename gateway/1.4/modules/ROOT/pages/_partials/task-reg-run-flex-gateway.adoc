...
IMPORTANT: Create a new directory and then run the registration command in this new directory. Your registration file(s) are stored where you run the registration command.
