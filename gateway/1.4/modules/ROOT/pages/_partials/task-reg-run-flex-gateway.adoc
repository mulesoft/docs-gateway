...
In Runtime Manager, click *&#8592; Flex Gateway* in the left navigation, and find your gateway. 
The gateway's status is currently disconnected. To connect, start the gateway.
