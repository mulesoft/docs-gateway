...
// tag::app-k8s-heading[]
== Register and Run with a Connected App on Kubernetes
// end::app-k8s-heading[]
// tag::user-k8s-heading[]
== Register and Run with a Username and Password on Kubernetes
// end::user-k8s-heading[]
// tag::token-k8s-heading[]
== Register and Run with a Token on Kubernetes
