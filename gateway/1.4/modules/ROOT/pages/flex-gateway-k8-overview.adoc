...
The following diagram demonstrates multiple Flex Replicas deployed as ingress controllers. The Flex Replicas sits behind a load balancer and manage all incoming traffic. 
