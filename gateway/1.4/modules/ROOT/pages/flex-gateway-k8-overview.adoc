...
* In Local Mode, Flex Gateway uses an ingress controller to manage an `Ingress` resource that is created manually or though a continuous integration/continuous development (CI/CD) pipeline by using `kubectl apply`. 
