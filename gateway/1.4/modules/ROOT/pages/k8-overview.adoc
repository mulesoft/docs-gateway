= Flex Gateway Modes in Kubernetes
ifndef::env-site,env-github[]
include::_attributes.adoc[]
endif::[]
:imagesdir: ../assets/images

//TODO: WE COULD ADD OTHER HIGH-LEVEL INFO HERE
// * Production requirements? Or should we just add that to https://dev-docs-internal.kqa.msap.io/beta-flex-gateway-get-well/gateway/1.4/flex-review-prerequisites
