...
*** xref:flex-conn-node-affinity-config.adoc[Configure Selection of Kubernetes Nodes for Pods Containing Flex Gateway]
...
*** xref:flex-local-node-affinity-config.adoc[Configure a Node for Deployments on Kubernetes]
