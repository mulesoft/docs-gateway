...
* xref:stub.adoc[Publishing APIs]
...
* xref:stub.adoc[Securing and Governing APIs]
...
** xref:stub.adoc[Custom Policies]
* xref:stub.adoc[Monitoring and Logging]
** xref:stub.adoc[Monitoring and Logging in Connected Mode]
...
** xref:stub.adoc[Monitoring and Logging in Local Mode]
...
// remove and add prerequisites to overview
// * xref:flex-review-prerequisites.adoc[Review Prerequisites]
// remove and add shared responsibility to overview
