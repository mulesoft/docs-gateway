...
between service names spaces is restricted so all traffic must pass through Flex Gateway. If a service does not require Flex Gateway management, you don't need to restrict traffic to it's name space.
