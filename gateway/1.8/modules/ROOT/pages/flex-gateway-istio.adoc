...
* Flex Gateway acts as an ingress gateway managing all incoming north-south traffic to the cluster. 
* Flex Gateway protects and monitors the exposed product page service. 
* Flex Gateway acts as an ingress gateway managing all east-west traffic to the reviews service.
