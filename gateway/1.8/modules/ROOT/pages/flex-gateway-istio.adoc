...
Integrate Flex Gateway into your Istio Service Mesh to leverage Flex Gateway policies, logging, metrics, and the Anypoint Platform control plane. Implement Flex Gateway as an ingress gateway to manage incoming north-south cluster traffic and internal east-west traffic inside the cluster.
