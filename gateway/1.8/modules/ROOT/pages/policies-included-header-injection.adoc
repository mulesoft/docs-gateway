...
If the injected header exists in the message attributes, the policy creates a new header without overriding the value of the existing one. However, you can't overwrite or inject the `host` header.
