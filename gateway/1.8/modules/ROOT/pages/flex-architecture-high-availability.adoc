...
This implementation is similar to <<implementation-1b>> and has the same considerations. Deploy region specific gateways and apply the necessary policies to the different APIs. 
