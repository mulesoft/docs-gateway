...
|*US*|*flex-packages.anypoint.mulesoft.com* | 443| Both| Required to download and install Flex Gateway on Linux deployments| HTTPS
...
|*EU*|*flex-packages.anypoint.mulesoft.com* | 443| Both| Required to download and install Flex Gateway on Linux deployments| HTTPS
|*EU*|*flex-packages.eu1.anypoint.mulesoft.com* | 443| Both| Required to download and install Flex Gateway on Linux deployments| HTTPS
|===
