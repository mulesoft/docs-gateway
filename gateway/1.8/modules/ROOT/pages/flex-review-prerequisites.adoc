...
The hard limits for Flex Gateway are as follows. Exceeding these limits will cause errors.
...
The supported limits for Flex Gateway are as follows. Exceeding these limits will will not cause errors, but is not supported.
