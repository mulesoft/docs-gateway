...
== Order instance-Level Policies in Connected Mode

To reorder instance-level policies in Flex Gateway running in Connected Mode:

. Go to *Anypoint Platform > API Manager*.

. In *API Instance* or *Agent and Tool Instances*, click the name of the instance whose policies you want to reorder.
