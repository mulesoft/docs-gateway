...
* `violation.clientId` (Only available in request context)
* `violation.clientName` (Only available in request context)
* `violation.policyName` (Only available in request context)
* `violation.violationType` (`VIOLATION` or `ERROR`, only available in request context)
