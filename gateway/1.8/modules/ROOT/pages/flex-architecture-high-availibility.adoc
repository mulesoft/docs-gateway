...
Flex must be installed in a multi-availability Zone mode to ensure live failover. Standard Kubernetes Availability Zone (AZ) distribution policies can be used to distribute Flex replicas across zones.
...
=== Scenario 3B: direct traffic using different
