...
+
The default Kubernetes readiness probe is configured to be error-tolerant. This enables Flex Gateway to scale even though there might be configuration errors. Edit the Helm chart to adjust error tolerance. To learn more about error tolerance, see <<configure-error-tolerance>>.
+
