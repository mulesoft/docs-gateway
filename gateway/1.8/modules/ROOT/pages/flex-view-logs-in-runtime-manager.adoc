...
Runtime Manager stores up to 100 MB of logs per Flex Gateway for 30 days. Runtime Manager automatically purges logs that go beyond 100 MB per Flex Gateway. If you need more storage, either use Anypoint Monitoring (Titanium subscription required) or use a third-party logging service. 
