= Configuring External Logs for Omni Gateway in Local Mode
ifndef::env-site,env-github[]
include::_attributes.adoc[]
endif::[]
:imagesdir: ../assets/images
:page-mode: local
:page-aliases: flex-local-third-party-logs-config.adoc, gateway::flex-local-view-manage-logs.adoc
...
To apply a Message Logging policy, see xref:gateway-secure-local.adoc[] and use the xref:gateway::policies-included-message-logging.adoc[Message Logging Configuration Parameters].
