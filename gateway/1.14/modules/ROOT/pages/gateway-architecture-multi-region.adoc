...
If using Redis shared storage, Redis synchronization isn't required if a cache loss during failover is acceptable. If using distributed shared storage, no synchronization is needed.
