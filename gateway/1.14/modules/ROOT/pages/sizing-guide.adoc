= Resource Sizing for Self-Managed Omni Gateway
ifndef::env-site,env-github[]
include::_attributes.adoc[]
endif::[]
:imagesdir: ../assets/images
:table-caption!:
:page-aliases: flex-sizing-guide.adoc

Before getting started with Omni Gateway, analyze and choose your configuration to obtain the best performance and auto-scaling rate.
