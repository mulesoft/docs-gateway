= Configuring a Forward Proxy for Omni Gateway in Connected Mode
ifndef::env-site,env-github[]
include::_attributes.adoc[]
endif::[]
:imagesdir: ../assets/images
:page-mode: conn
:page-aliases: flex-conn-forward-proxy.adoc
...
== See also
* xref:conn-reg-run.adoc[Register and Run Omni Gateway in Connected Mode]
