...
The `logging` object configures the delivery of runtime/access logs enabled via the message logging policy. Logs are delivered to any supported https://docs.fluentbit.io/manual/v/1.8/pipeline/outputs[Fluent Bit 1.8.1^] output.
