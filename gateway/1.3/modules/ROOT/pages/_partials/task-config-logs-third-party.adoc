//tag::intro1[]
Anypoint Flex Gateway enables you to configure log output for consumption by third-party services. Logs can be delivered to any supported https://docs.fluentbit.io/manual/v/1.8/pipeline/outputs[Fluent Bit 1.8.11^] output. You configure log output via a custom YAML file.
