...
. **Manage an API with Flex Gateway:** Use your Flex Gateway to manage API instances and apply xref:policies-included-overview.adoc[included], xref:policies-automated-overview.adoc[automated], and xref:policies-custom-overview.adoc[custom] policies.
