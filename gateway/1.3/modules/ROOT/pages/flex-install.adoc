...
[source,ssh]
----
sudo rpm --import https://flex-packages.devx.anypoint.mulesoft.com/amazonlinux/pubkey.gpg
sudo yum-config-manager --add-repo https://flex-packages.devx.anypoint.mulesoft.com/amazonlinux/2
sudo yum install flex-gateway
----
...
[source,ssh]
----
sudo rpm --import https://flex-packages.devx.anypoint.mulesoft.com/rhel/pubkey.gpg
sudo yum-config-manager --add-repo https://flex-packages.devx.anypoint.mulesoft.com/rhel/9
sudo yum install flex-gateway
----
...
[source,ssh]
----
sudo rpm --import https://flex-packages.devx.anypoint.mulesoft.com/centos/pubkey.gpg
sudo yum-config-manager --add-repo https://flex-packages.devx.anypoint.mulesoft.com/centos/8
sudo yum install flex-gateway
----
