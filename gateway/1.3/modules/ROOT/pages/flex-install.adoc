...
baseurl = https://flex-packages.anypoint.mulesoft.com/amazonlinux/$releasever
gpgcheck=1
...
[flex-gateway]
name = Anypoint Flex Gateway
baseurl = https://flex-packages.anypoint.mulesoft.com/rhel/$releasever
gpgcheck=1
...
[flex-gateway]
name = Anypoint Flex Gateway
baseurl = https://flex-packages.anypoint.mulesoft.com/centos/$releasever
gpgcheck=1
