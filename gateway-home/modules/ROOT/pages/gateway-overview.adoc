...
Anypoint Platform offers two different runtime options for managing and securing your APIs.
...
image::gateway-concepts-control-plane-diagram.png["Flex Gateway Concepts diagram,"width=80%]

=== Flex Gateway Architecture

Flex Gateway contains two components that work in tandem: the control plane, and the runtime.
