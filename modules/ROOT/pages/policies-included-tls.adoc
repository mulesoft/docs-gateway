...
Using HTTPS protects the communication between the client and Flex Gateway with encryption. To use HTTPS as your schema, the Transport Layer Security policy must be bound to your API instance. 

== Configuring Policy Parameters

=== Flex Gateway

If you want to use HTTPS as your Schema
...
| Optional
| 
|A prioritized list of supported application level protocols; for example, h2, http/1.1, etc.
