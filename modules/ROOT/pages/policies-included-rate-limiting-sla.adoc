...
:page-aliases: api-manager::rate-limiting-sla-policy.adoc, api-manager::rate-limiting-and-throttling-sla-based-policies.adoc
...
| Optional
| If it's empty doesn't validate the secret associated to the API
