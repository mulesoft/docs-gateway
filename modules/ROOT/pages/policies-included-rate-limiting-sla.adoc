...
For example, 5 replicas have been created in a single Flex Gateway registration. You configure the Rate Limiting policy for 10 requests per minute. Each replica will have a limit of 10 requests per minute.
====
