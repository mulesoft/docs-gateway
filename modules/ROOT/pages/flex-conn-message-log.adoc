...
+
You can only enter one level, but you can add an additional configuration
to include a different severity level. See <<severity-levels, Message Logging Severity Levels>>
...
Message Logging severity levels include the following:
