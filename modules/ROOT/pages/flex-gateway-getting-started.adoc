...
* **Local:** Run Flex Gateway in local mode if you want to run it mostly disconnected
from the Anypoint control plane, and manage it with locally stored declarative configuration files.
* **Connected:** Run Flex Gateway in connected mode if you want it fully connected to the Anypoint
