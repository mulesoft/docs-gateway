...
For inline configurations, enable access logs by adding `Message Logging` to the `spec.policies` section of `ApiInstance`. The following is an inline configuration example:
