...
include::partial$task-reg-run-flex-gateway.adoc[tags=app-docker-heading;reg-command-intro;sub-coll-info;app-replace-content;environment-replace-content;replace-content;reg-command-heading;reg-command-1;docker-reg-command;app-reg-command;environment-reg-command;connected-reg-command;reg-command-2;after-reg;after-reg-2;connected-after-reg;start-command;gateway-connected]

// Register and run with a connected app as a kubernetes ingress controller
include::partial$task-reg-run-flex-gateway.adoc[tags=app-k8s-heading;k8s-reg-command-intro;sub-coll-info;app-replace-content;environment-replace-content;replace-content;reg-command-heading;reg-command-1;docker-reg-command;app-reg-command;environment-reg-command;connected-reg-command;reg-command-2;after-reg;k8s-after-reg;connected-after-reg;k8s-install-helm-chart;gateway-connected;helm-chart-options]
