...
+
After creating the basic structure to contain the policy configuration, it is required to implement the `on_configure` method belonging to the `RootContext` trait in order to deserialize it.
