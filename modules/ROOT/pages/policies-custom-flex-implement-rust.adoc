...
+
The last step created the basic structure to contain each field of the policy configuration. Now, in order to deserialize the configuration, it is required to implement the `on_configure` method belonging to the `RootContext` trait.
