...
All of the xref:api-manager::policies-ootb-landing-page.adoc[Included Policies], and any xref:api-manager::policy-mule3-custom-policies.adoc[Mule 4 Custom Policy] can be configured as automated policies and can be configured to be applied at all the API’s running under an environment.
