...
:page-aliases: api-manager::openam-oauth-token-enforcement-policy.adoc
...
* xref:api-manager::apply-oauth-token-policy-task.adoc[Applying an OAuth 2.0 Token Validation Policy]
* xref:api-manager::using-policies.adoc[Applying a Policy]
...
* xref:api-manager::configure-autodiscovery-4-task.adoc[Configuring API Gateway API Autodiscovery in a Mule 4 Application]
* xref:api-manager::configure-autodiscovery-3-task.adoc[Configuring API Gateway API Autodiscovery in a Mule 3 Application]
