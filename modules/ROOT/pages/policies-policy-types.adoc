...
:page-aliases: api-manager::policies-policy-types.adoc
...
* xref:api-manager::policies-custom-landing-page.adoc[Custom Policies]
* xref:api-manager::policies-custom-offline-landing-page.adoc[Custom Offline Policies]
* xref:api-manager::automated-policies-landing-page.adoc[Automated Policies]
* xref:api-manager::policies-policy-level.adoc[Resource-Level Policies]
* xref:api-manager::gatekeeper.adoc[Gatekeeper Enhanced Security]
