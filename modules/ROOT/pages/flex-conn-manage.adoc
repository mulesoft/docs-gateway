...
* xref:api-manager::create-instance-task.adoc[Add an API Instance in API Manager]. - An API Instance is a proxy of an API that serves the upstream. API instances support the application of policies
