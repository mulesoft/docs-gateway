...
Before executing the start command below, update the FLEX_NAME to the name you want to assign to your Flex Replica.
...
Before executing the start command below, update the absolute path to the directory where your Flex Gateway configuration files will reside. Additionally, update the FLEX_NAME with the name you want to assign to your Flex Replica.
...
--set-file registerContent=registration.yaml
----
+
