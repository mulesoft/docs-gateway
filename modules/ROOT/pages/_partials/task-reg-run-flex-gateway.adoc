...
Before executing the start command below, update the absolute path to the directory where your Flex Gateway configuration files will reside. Additionally, update the absolute path to the directory where your Flex Gateway registration files reside.
