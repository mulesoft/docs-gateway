...
--anypoint-url=https://qax.anypoint.mulesoft.com \
my-gateway
----
...
[source,ssh,subs=attributes+]
----
docker run --entrypoint flexctl -w /registration "$(pwd)":/registration mulesoft/flex-gateway:{gateway-ver-var} \
register -v \
...
-p 8081:8081 \
-e MGW_RTM_ARM_AGENT_URL=wss://arm-mcm2-service.kqa.msap.io:443/agent \
...
----
[Service]
Environment=MGW_RTM_ARM_AGENT_URL=wss://arm-mcm2-service.kqa.msap.io:443/agent
