...
// tag::conn-reg-command-1[]

[source,ssh,subs=attributes+]
----
# end::conn-reg-command-1[]
# tag::conn-docker-reg-command[]
docker run --entrypoint flexctl -w /registration -v "$(pwd)":/registration mulesoft/flex-gateway:{gateway-ver-var} \
register \
# end::conn-docker-reg-command[]
# tag::conn-linux-reg-command[]
flexctl -v register \
# end::conn-linux-reg-command[]
# tag::conn-user-reg-command[]
--username=<your-username> \
--password=<your-password> \
# end::conn-user-reg-command[]
# tag::conn-app-reg-command[]
--client-id=<your-connected-app-client-id> \
--client-secret=<your-connected-app-client-secret> \
# end::conn-app-reg-command[]
# tag::conn-reg-command-2[]
--environment=<your-environment-id> \
--organization=<your-org-id> \
--anypoint-url=https://<your-instance>.anypoint.mulesoft.com \
my-gateway
----
// end::conn-reg-command-2[]
// tag::conn-after-reg[]
...
// tag::conn-create-config-folder-file[]
...
// end::conn-create-config-folder-file[]
