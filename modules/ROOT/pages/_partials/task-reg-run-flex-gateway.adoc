...
// tag::heading1[]
= Registering and Running in Connected Mode with a {page-reg-type-title}
// end::heading1[]
// tag::page-metadata[]
...
// end::page-metadata[]
// tag::page-metadata-user[]
:page-reg-type-title: Username and Password
:page-reg-type-link1: up
:page-reg-type-link2: username-and-password
// end::page-metadata-user[]
// tag::page-metadata-app[]
:page-reg-type-title: Connected App
:page-reg-type-link1: app
:page-reg-type-link2: connected-app
// end::page-metadata-app[]

// tag::icon-selection[]

[cols="1a,1a",subs=attributes+]
|===
|image:install-docker-logo.png[25%,25%,xref="flex-conn-reg-run-{page-reg-type-link1}.adoc#register-and-run-with-a-{page-reg-type-link2}-in-a-docker-container"]
|image:install-linux-logo.png[20%,20%,xref="flex-conn-reg-run-{page-reg-type-link1}.adoc#register-and-run-with-a-{page-reg-type-link2}-as-a-linux-service"]

|xref:flex-conn-reg-run-{page-reg-type-link1}.adoc#register-and-run-with-a-{page-reg-type-link2}-in-a-docker-container[Register and Run with a {page-reg-type-title} in a Docker Container]
|xref:flex-conn-reg-run-{page-reg-type-link1}.adoc#register-and-run-with-a-{page-reg-type-link2}-as-a-linux-service[Register and Run with a {page-reg-type-title} as a Linux Service]
|===
...
// end::prerequisites[]
// tag::prerequisites-user[]

** The *Username* and *Password* of a user with _Admin_ permissions for Runtime Manager

// end::prerequisites-user[]
// tag::docker-heading[]
== Register and Run with a {page-reg-type-title} in a Docker Container
// end::docker-heading[]
// tag::linux-heading[]
== Register and Run with a {page-reg-type-title} as a Linux Service
// end::linux-heading[]
