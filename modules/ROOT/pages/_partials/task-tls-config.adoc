...
[cols="1a,1a,1a"]
|===
|image:gateway::install-linux-logo.png[20%,20%,xref="flex-{page-mode}-tls-config.adoc#configure-tls-context-for-flex-gateway-as-a-linux-service"]
|image:gateway::install-docker-logo.png[25%,25%,xref="flex-{page-mode}-tls-config.adoc#configure-tls-context-for-flex-gateway-in-a-docker-container"]
...
* xref:gateway::flex-install.adoc[Install Flex Gateway]
* xref:gateway::flex-{page-mode}-reg-run.adoc[Register and Run Flex Gateway]
