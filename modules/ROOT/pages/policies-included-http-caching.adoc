...
Distributed Caching relies on Shared Storage available in the Gateway. More details can be found in xref:gateway::flex-conn-shared-storage-config.adoc[this section].
