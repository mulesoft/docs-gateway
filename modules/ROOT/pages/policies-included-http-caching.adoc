...
Default value: `600`
| Yes
| Distributed (Mule only) | Configures the cache to be distributed among different nodes in a cluster.
If you are using CloudHub, ensure that you enable Object Store v2 when deploying an application.
Default value: `false`
| Yes
| Persistent Cache (Mule only) | Configures the cache to persist between different restarts of the Mule instance.
If you are using CloudHub, ensure that you enable Object Store v2 when deploying an application.
Default value: `false`
| Yes
