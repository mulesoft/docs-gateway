...
include::partial$task-rep-run-flex-gateway.adoc[tags=add-flex-rep-byb-conn;add-flex-replica1]

include::partial$task-reg-run-flex-gateway.adoc[tags=create-config-folder-file;config-content;linux-start-commands]

include::partial$task-rep-run-flex-gateway.adoc[tags=add-flex-replica2]
