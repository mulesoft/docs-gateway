...
include::partial$task-reg-run-flex-gateway.adoc[tags=user-k8s-heading;k8s-reg-command-intro;sub-coll-info;user-replace-content;environment-replace-content;replace-content;reg-command-heading;reg-command-1;docker-reg-command;user-reg-command;environment-reg-command;connected-reg-command;reg-command-2;after-reg;k8s-after-reg;connected-after-reg;k8s-install-helm-chart;gateway-connected;helm-chart-options]
