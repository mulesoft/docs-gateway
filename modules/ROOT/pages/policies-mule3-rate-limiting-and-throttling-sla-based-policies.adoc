...
:keywords: sla, portal
:page-aliases: api-manager::policy-mule3-rate-limiting-and-throttling-sla-based-policies.adoc
...
* xref:api-manager::tutorial-manage-an-api.adoc[To Apply a Policy and SLA Tier]
* xref:api-manager::tutorial-manage-an-api.adoc#adding-an-sla-tier[Create an SLA tier]