...
* Create alerts using the metrics related to an API instance with the xref:flex-api-alerts.adoc[Alerts feature in API Manager] or with the xref:anypoint-monitoring::basic-alerts.adoc[Basic Alerts feature in Anypoint Monitoring].
