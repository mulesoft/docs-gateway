...
When registering Anypoint Flex Gateway, you might encounter issues caused by incorrect access permissions. The following topics provide possible causes for registration issues and describe how to troubleshoot:
...
. Select "Manage Servers" from the *Select access* dropdown menu.
. Click the *+* button.
