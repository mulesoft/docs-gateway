...
|image:install-ubuntu-logo.png[20%,20%,xref="microgateway-install-run.adoc#install-and-run-as-an-ubuntu-image"]
...
|xref:microgateway-install-run.adoc#install-and-run-as-a-kubernetes-ingress-controller[See Install and Run as a Kubernetes Ingress Controller]
