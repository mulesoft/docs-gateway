...
----
+
The command returns something resembling the following: 
+
----
{
  "headers": {
...
----
+
The Grafana UI contains four graphs: *QPS by Status Code*, *95th percentile of Request Time*, *Runtime Logs*, and *Access Logs*. The *95th percentile of Request Time* graph resembles the following: 
+
