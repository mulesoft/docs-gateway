...
----
NAME READY STATUS RESTARTS AGE
pod/peregrine-59cbfd695c-5v5f8 1/1 Running 4 19h

NAME TYPE CLUSTER-IP EXTERNAL-IP PORT(S) AGE
service/peregrine ClusterIP 182.41.44.514 <none> 80/TCP 5d18h

NAME READY UP-TO-DATE AVAILABLE AGE
deployment/peregrine 1/1 1 1 19h
----
...
----
+
The command returns the following headers added by the `rate-limit` policy: 
+
----
...
+
----
curl -v http://$INGRESS_IP/httpbin/headers
----
