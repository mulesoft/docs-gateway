...
The Basic Authentication: LDAP policy is not supported in Flex Gateway Local Mode.

=== Flex Gateway Connected Mode

The Basic Authentication: LDAP policy is not supported in Flex Gateway Connected Mode.
