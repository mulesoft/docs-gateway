...
Install Flex Gateway on a Linux server, VM, or Kubernetes cluster. You can immediately start applying out-of-the-box policies to APIs, via declarative configuration files.
...
* HTTP/1.1 protocol
* HTTP/2 protocol
* Application gateway listeners - logical units that check for incoming connection requests.
