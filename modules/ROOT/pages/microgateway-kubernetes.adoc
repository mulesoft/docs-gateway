...
. https://drive.google.com/file/d/1s8Kv38f-xCKfKPdKvFHSdNiIfLPEUIax/view?usp=sharing[Download the Flex Gateway container^] and import the Docker container image: 
+
----
k3d image import -c flex-gateway-1 flex-gateway-1.0.0-beta.1.tar
----
+
The command should return the following: 
+
