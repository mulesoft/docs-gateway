...
Anypoint Flex Gateway supports two YAML configuration models: inline, and resource-based.

* The inline model is ideal for concise definitions. 
* The resource-based model, common in Kubernetes, is ideal for granular definitions.

Refer to the <<examples,Examples>> section for examples of both.

The following reference guide describes the available configuration resources.
