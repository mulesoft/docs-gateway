...
:page-aliases: api-manager::offline-policy-task.adoc
...
* Mule runtime engine (Mule) is installed with xref:mule-gateway-capabilities.adoc[API gateway capabilities] enabled.
* An xref:api-manger::api-instance-landing-page.adoc[API] configured with a basic endpoint or a proxy endpoint exists in API Manager.
