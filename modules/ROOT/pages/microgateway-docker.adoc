...
+
----
curl -o flex-gateway-1.0.0-beta.6.tar https://peregrine:48bcfd4617c9cce@d8wbbsqfcfi8u.cloudfront.net/docker/flex-gateway-1.0.0-beta.6.tar
----
...
+
----
docker load --input flex-gateway-1.0.0-beta.6.tar
----
...
mulesoft/flex-gateway        1.0.0-beta.6     1c1fbdbf819b   9 days ago     334MB
----
...
+
Additionally, the configuration applies a policy called `http-basic-authentication-flex`, and specifies credentials that incoming requests use when accessing the `jsonplaceholder` service.
...
+
----
docker run -it -p 8080:8080 -v /absolute/path/to/configuration/directory/:/etc/peregrine/conf.d/custom/ mulesoft/flex-gateway:1.0.0-beta.6
----
+
...
c2a360f8c9ed   mulesoft/flex-gateway:1.0.0-beta.6        "/init"   8 days ago   Up 8 days   0.0.0.0:8080->8080/tcp, :::8080->8080/tcp 
----
