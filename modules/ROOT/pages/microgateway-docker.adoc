...
+
----
curl -o flex-gateway-1.0.0-beta.1.tar https://peregrine:48bcfd4617c9cce@d8wbbsqfcfi8u.cloudfront.net/docker/flex-gateway-1.0.0-beta.1.tar
----

. Move the container image into a directory of your choice.
. Open a command line interface and navigate to the directory containing the container image.
