...
[source,ssh]
----
curl -o flex-gateway-1.0.0-beta.6.tar \
https://peregrine:48bcfd4617c9cce@d8wbbsqfcfi8u.cloudfront.net/docker/flex-gateway-1.0.0-beta.6.tar
----
...
[source,kubernetes]
----
k3d image import -c flex-gateway-1 flex-gateway-1.0.0-beta.6.tar
----
+
