...
* <<run-registration-command,Run the registration command>>
* <<install,Run the installation commands>>

These tasks apply to both connected and local modes.
...
|2
|The minimum number of replicas that the autoscaler is allowed to create

|`autoscaling.maxReplicas`
|11
|The maximum number of replicas that the autoscaler is allowed to create
