...
Installing Flex Gateway as a Linux service requires that you satisfy installation dependencies,
run installation commands, and verify successful installation.
