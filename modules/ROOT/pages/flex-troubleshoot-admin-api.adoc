...
The Flex Gateway Admin API enables you to query for information related to a gateway's API instances, services, and configurations. The CLI includes a command to query that:
...
To see a JSON representation of your API instance, execute the `flexctl dump` command, and check for a file called `api-instances.json`. 
