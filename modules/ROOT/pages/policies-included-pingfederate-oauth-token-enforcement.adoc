...
:keywords: pingfederate oauth 2.0 token enforcement, api gateway, flex gateway, gateway, policy
:page-aliases: api-manager::policy-ping-federate.adoc
...
The PingFederate OAuth 2.0 Token Enforcement policy is not supported in Flex Gateway Local Mode.

=== Flex Gateway Connected Mode

The PingFederate OAuth 2.0 Token Enforcement policy is not supported in Flex Gateway Connected Mode.
