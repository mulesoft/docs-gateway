...
. Click *Edit* from the three-dots menu (image:three-dots-menu.png[Menu icon from which you can edit the alert]) on the alert you want to edit.
+
...
+
. Click *Delete* from the three-dots menu (image:three-dots-menu.png[Menu icon from which you can edit the alert]) on the alert you want to delete. You can also delete an alert when editing it.
