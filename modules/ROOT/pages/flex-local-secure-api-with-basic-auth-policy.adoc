...
The following procedures demonstrate a simple YAML configuration for an API with multiple upstream services, all secured with basic authentication and rate limiting. 
