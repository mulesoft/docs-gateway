...
Publish an API running behind Flex Gateway in Local Mode, modifying YAML configuration data by one of the following methods:

* Linux and Docker: `.yaml` files
* Kubernetes: `kubectl apply`

The following procedures demonstrate a simple YAML configuration for an unsecured API with multiple upstream services.
