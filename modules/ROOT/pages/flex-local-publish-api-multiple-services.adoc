...
|image:install-kubernetes-logo.png[20%,20%,xref="flex-local-publish-api-multiple-services.adoc#publish-an-api-running-behind-flex-gateway-on-kubernetes"]
...
|xref:flex-local-publish-api-multiple-services.adoc#publish-an-api-running-behind-flex-gateway-on-kubernetes[Publish an API running behind Flex Gateway on Kubernetes]
